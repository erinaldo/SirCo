...
'mreyes 17/Junio/2015   10:23 a.m.

Public Class DALCorteFolios
    Inherits DALOdbc
...
#Region " Public Role Functions "
    ...
    Public Function usp_PpalCorteFolios(ByVal Sucursal As String, ByVal FechaIni As String, ByVal FechaFin As String) As DataSet
        'mreyes 17/Junio/2015   11:04 a.m.
        Try
            usp_PpalCorteFolios = New DataSet
            MyBase.SQL = "CALL usp_PpalCorteFolios(?,?,?)"
            ...
            MyBase.FillDataSet(usp_PpalCorteFolios, "cipsis")
    ...
    Public Function usp_Captura_Bulto(ByVal Opcion As Integer, ByVal IdFolioB As Integer, ByVal ProveedorB As String, ByVal MarcaB As String, ByVal NoGuiaB As String, _
                              ...
                              ByVal fumdetalleB As DateTime, ByVal EntraJaulaB As Integer, ByVal SaleJaulaB As Integer, ByVal SubecamionB As Integer, _
                                ByVal generotraspasoB As Integer, ByVal IdFolioSucB As String, ByVal statusb As String, ByVal tipob As String, ByVal SFb As Integer) As Boolean
        ...
        Try
            ...
            MyBase.AddParameter("@TransportaB", OdbcType.Char, 25, TransportaB)
