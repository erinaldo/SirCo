Public Class BCLTraspasos
    'miguel pérez 09/Octubre/2012 11:16 a.m.

    Implements IDisposable
    Private objDALTraspasos As DAL.DALTraspasos
    Private disposedValue As Boolean = False        ' To detect redundant calls

    ' IDisposable
#Region "Constructor And Destructor"
    Public Sub New(ByVal Constring As String)
9:      objDALTraspasos = New DAL.DALTraspasos(Constring)
    End Sub
...
#Region " Public Section Functions "
    ...
    Public Function usp_CapturaTraspasoOri(ByVal Opcion As Integer, ByVal Sucursal As String, ByVal Traspaso As String, ByVal Tipo As String, ByVal IdFolio As Integer, ByVal Estatus As String, _
        ...
        Try
            ...
            Return objDALTraspasos.usp_CapturaTraspasoOri(Opcion, Sucursal, Traspaso, Tipo, IdFolio, Estatus, Fecha, Hora, SucurDes, Observa, Usuario, _
                                                          Ctd, Costo, Precio, Envia, Transporta, IdUsuario)
        Catch ExceptionErr As Exception
            Throw New System.Exception(ExceptionErr.Message, _
                ExceptionErr.InnerException)
        End Try
    ...
    Public Function usp_CapturaTraspasoDes(ByVal Opcion As Integer, ByVal Sucursal As String, ByVal Traspaso As String, ByVal Tipo As String, ByVal Estatus As String, _
        ...
        Try
            'Call the data component to add the new group
            Return objDALTraspasos.usp_CapturaTraspasoDes(Opcion, Sucursal, Traspaso, Tipo, TipoRec, Estatus, Fecha, Hora, SucurOri, Referenc, Observa, Usuario, _
    ...
    Public Function usp_CapturaDetTraspasoOri(ByVal Opcion As Integer, ByVal Idtraspaso As Integer, ByVal Sucursal As String, ByVal Traspaso As String, _
        ...
        Try
            ...
            'Call the data component to add the new group
            Return objDALTraspasos.usp_CapturaDetTraspasoOri(Opcion, Idtraspaso, Sucursal, Traspaso, IdArticulo, Marca, Estilon, Proveedor, Corrida, Medida, Serie, ctdori, Costo, Precio)
        Catch ExceptionErr As Exception
            Throw New System.Exception(ExceptionErr.Message, _
                ExceptionErr.InnerException)
        End Try
    ...
    Public Function usp_CapturaDetTraspasoDes(ByVal Opcion As Integer, ByVal Idtraspaso As Integer, ByVal Sucursal As String, ByVal Traspaso As String, _
        ...
        Try
            'Call the data component to add the new group
            Return objDALTraspasos.usp_CapturaDetTraspasoDes(Opcion, Idtraspaso, Sucursal, Traspaso, IdArticulo, Marca, Estilon, Proveedor, Corrida, Medida, Serie, ctddes, Costo, Precio)
        Catch ExceptionErr As Exception
            Throw New System.Exception(ExceptionErr.Message, _
            ExceptionErr.InnerException)
        End Try
    ...
    Public Function usp_TraerTraspasoManualEnvioDet(ByVal Sucursal As String, ByVal Traspaso As String, ByVal Sucurdes As String, _
        ...
        'Tony Garcia - 19/Agosto/2013 - 11:20 am
        Try
            Return objDALTraspasos.usp_TraerTraspasoManualEnvioDet(Sucursal, Traspaso, Sucurdes, IdTraspaso)
        Catch ExceptionErr As Exception
            Throw New System.Exception(ExceptionErr.Message, _
                ExceptionErr.InnerException)
        End Try
