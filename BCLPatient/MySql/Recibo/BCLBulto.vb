Public Class BCLBulto
    'mreyes 20/Enero/2013 10:14 a.m.

    Implements IDisposable
    Private objDALBulto As DAL.DALBulto
    Private disposedValue As Boolean = False        ' To detect redundant calls

    ' IDisposable
#Region "Constructor And Destructor"
    Public Sub New(ByVal Constring As String)
9:      objDALBulto = New DAL.DALBulto(Constring)
    End Sub
...
#Region " Public Section Functions "
    ...
    Public Function usp_Captura_Plano(ByVal Marca As String, ByVal Estilon As String, ByVal Archivo As String) As Boolean
        ...
        Try
            ...
            usp_Captura_Plano = objDALBulto.usp_Captura_Plano(Marca, Estilon, Archivo)
    ...
    Public Function usp_Captura_Bulto(ByVal Opcion As Integer, ByVal IdFolioB As Integer, ByVal ProveedorB As String, ByVal MarcaB As String, ByVal NoGuiaB As String, _
                              ...
                              ByVal subecamionB As Integer, ByVal generotraspasoB As Integer, ByVal IdFolioSucB As String, ByVal statusb As String, ByVal tipob As String, ByVal SFb As Integer, ByVal Paqueteria As String) As Boolean


        'mreyes 20/Enero/2013 10:14 a.m.
        ' 1  = INICIO REGISTRO DE BULTOS
        ' 2  = ASIGNACIÓN DE BULTOS
        ' 3  = RECIBO A DETALLE
        ' 4  = ENTRADA A JAULA 
        ' 5  = SALIDA DE JAULA 
        ' 6  = SUBE AL CAMION
        ...
        Try
            ...
            usp_Captura_Bulto = objDALBulto.usp_Captura_Bulto(Opcion, IdFolioB, ProveedorB, MarcaB, NoGuiaB, _
                                                              TransportaB, NoBultosB, NoSucursalB, comentariosB, RecibeB, fecrecibeB, asignaB, fecasignaB, usuarioB, fumB, usuarioasignaB, fumasignaB, detalleB, fumdetalleB, entrajaulaB, salejaulaB, subecamionB, generotraspasoB, IdFolioSucB, statusb, tipob, SFb, Paqueteria)
        Catch ExceptionErr As Exception
            Throw New System.Exception(ExceptionErr.Message, _
                ExceptionErr.InnerException)
        End Try
    ...
    Public Function usp_PpalBultosDetallado(ByVal Opcion As Integer, ByVal Sucursal As String) As DataSet
        ...
        Try
            Return objDALBulto.usp_PpalBultosDetallado(Opcion, Sucursal)
        Catch ExceptionErr As Exception
            Throw New System.Exception(ExceptionErr.Message, _
                ExceptionErr.InnerException)
        End Try
    ...
    Public Function usp_Captura_DetCodigo(ByVal Opcion As Integer, ByVal Section As DataSet) As Boolean
        ...
        Try
            ...
            Return objDALBulto.usp_Captura_DetCodigo(Opcion, Section)
        Catch ExceptionErr As Exception
            Throw New System.Exception(ExceptionErr.Message, _
                ExceptionErr.InnerException)
        End Try
    ...
    Public Function usp_PpalBultosDetalladoDet(ByVal Opcion As Integer, ByVal Sucursal As String, ByVal Proveedor As String, ByVal Noguia As String, _
        ...
        'Tony Garcia - 24/Enero/2013 - 12:50 p.m.
        Try
            Return objDALBulto.usp_PpalBultosDetalladoDet(Opcion, Sucursal, Proveedor, Noguia, Folio, Recibe, Asigna, FechaRecIni, FechaRecFin, FechaAsigIni, FechaAsigFin, CveSucursal, Status, Tipo)
        Catch ExceptionErr As Exception
            Throw New System.Exception(ExceptionErr.Message, _
                ExceptionErr.InnerException)
        End Try
    ...
    Public Function usp_TraerBulto(ByVal IdFolio As String, ByVal IdFolioSuc As String) As DataSet
        ...
        Try
            ...
            usp_TraerBulto = objDALBulto.usp_TraerBulto(IdFolio, IdFolioSuc)
        Catch ExceptionErr As Exception
            Throw New System.Exception(ExceptionErr.Message, _
                ExceptionErr.InnerException)
        End Try
    ...
    Public Function usp_TraerDetCodigo(ByVal Codigo As String) As DataSet
        ...
        Try
            'Call the data component to get all groups
            usp_TraerDetCodigo = objDALBulto.usp_TraerDetCodigo(Codigo)
        Catch ExceptionErr As Exception
            Throw New System.Exception(ExceptionErr.Message, _
                ExceptionErr.InnerException)
        End Try
    ...
    Public Function pub_TraerIdFolio(ByVal IdFolioSuc As String) As DataSet
        ...
        Try
            'Call the data component to get all groups
            pub_TraerIdFolio = objDALBulto.pub_TraerIdFolio(IdFolioSuc)
        Catch ExceptionErr As Exception
            Throw New System.Exception(ExceptionErr.Message, _
                ExceptionErr.InnerException)
        End Try
    ...
    Public Function usp_TraerFolioDevoProv(ByVal IdFolio As Integer) As DataSet
        ...
        Try
            'Call the data component to get all groups
            usp_TraerFolioDevoProv = objDALBulto.usp_TraerFolioDevoProv(IdFolio)
        Catch ExceptionErr As Exception
            Throw New System.Exception(ExceptionErr.Message, _
                ExceptionErr.InnerException)
        End Try
    ...
    Public Function usp_TraerFolioEntrada(ByVal IdFolio As Integer) As DataSet
        ...
        Try
            'Call the data component to get all groups
            usp_TraerFolioEntrada = objDALBulto.usp_TraerFolioEntrada(IdFolio)
        Catch ExceptionErr As Exception
            Throw New System.Exception(ExceptionErr.Message, _
                ExceptionErr.InnerException)
        End Try
    ...
    Public Function usp_TraerIdFolioSucBulto(ByVal IdFolio As Integer) As DataSet
        ...
        Try
            'Call the data component to get all groups
            usp_TraerIdFolioSucBulto = objDALBulto.usp_TraerIdFolioSucBulto(IdFolio)
        Catch ExceptionErr As Exception
            Throw New System.Exception(ExceptionErr.Message, _
                ExceptionErr.InnerException)
        End Try
    ...
    Public Function pub_TraerIdFolioBulto(ByVal IdFolioSuc As String) As DataSet
        ...
        Try
            'Call the data component to get all groups
            pub_TraerIdFolioBulto = objDALBulto.pub_TraerIdFolioBulto(IdFolioSuc)
        Catch ExceptionErr As Exception
            Throw New System.Exception(ExceptionErr.Message, _
                ExceptionErr.InnerException)
        End Try
    ...
    Public Function usp_EliminarAparadorLeer(ByVal Serie As String) As DataSet
        ...
        Try
            'Call the data component to get all groups
            usp_EliminarAparadorLeer = objDALBulto.usp_EliminarAparadorLeer(Serie)
        Catch ExceptionErr As Exception
            Throw New System.Exception(ExceptionErr.Message, _
                ExceptionErr.InnerException)
        End Try
    ...
    Public Function usp_EliminarDetBulto(ByVal IdFolio As Integer) As DataSet
        ...
        Try
            'Call the data component to get all groups
            usp_EliminarDetBulto = objDALBulto.usp_EliminarDetBulto(IdFolio)
        Catch ExceptionErr As Exception
            Throw New System.Exception(ExceptionErr.Message, _
                ExceptionErr.InnerException)
        End Try
    ...
    Public Function usp_TraerDetBulto(ByVal IdFolio As Integer, ByVal Sucursal As String, ByVal Pedido As String) As DataSet
        ...
        Try
            'Call the data component to get all groups
            usp_TraerDetBulto = objDALBulto.usp_TraerDetBulto(IdFolio, Sucursal, Pedido)
        Catch ExceptionErr As Exception
            Throw New System.Exception(ExceptionErr.Message, _
                ExceptionErr.InnerException)
        End Try
    ...
    Public Function usp_PpalBulto(ByVal FolioA As String, ByVal FolioB As String, ByVal Sucursal As String, ByVal Proveedor As String, ByVal FechaIni As String, ByVal FechaFin As String) As DataSet
        ...
        Try
            'Call the data component to get all groups
            usp_PpalBulto = objDALBulto.usp_PpalBulto(FolioA, FolioB, Sucursal, Proveedor, FechaIni, FechaFin)
        Catch ExceptionErr As Exception
            Throw New System.Exception(ExceptionErr.Message, _
                ExceptionErr.InnerException)
        End Try
    ...
    Public Function usp_ActualizaBultos(ByVal Folio As String, ByVal Sucursal As String, ByVal Proveedor As String, ByVal NoGuia As String, _
        ...
        Try
            'Call the data component to get all groups
            usp_ActualizaBultos = objDALBulto.usp_ActualizaBultos(Folio, Sucursal, Proveedor, NoGuia, Transporta, NoBultos, Recibe, _
    ...
    Public Function usp_Captura_DetBulto(ByVal Opcion As Integer, ByVal Section As DataSet) As Boolean
        Try
            ...
            Return objDALBulto.usp_Captura_DetBulto(Opcion, Section)
        Catch ExceptionErr As Exception
            Throw New System.Exception(ExceptionErr.Message, _
                ExceptionErr.InnerException)
        End Try
    ...
    Public Function usp_PpalAntiJaula(ByVal Accion As Integer, ByVal Opcion As Integer, ByVal Sucursal As String) As DataSet
        ...
        Try
            Return objDALBulto.usp_PpalAntiJaula(Accion, Opcion, Sucursal)
        Catch ExceptionErr As Exception
            Throw New System.Exception(ExceptionErr.Message, _
                ExceptionErr.InnerException)
        End Try
    ...
    Public Function usp_PpalAntiJaulaDet(ByVal Accion As Integer, ByVal Opcion As Integer, ByVal Sucursal As String, ByVal Proveedor As String, ByVal Noguia As String, _
        ...
        Try
            Return objDALBulto.usp_PpalAntiJaulaDet(Accion, Opcion, Sucursal, Proveedor, Noguia, Folio, Recibe, Asigna, FechaRecIni, FechaRecFin, FechaAsigIni, FechaAsigFin, DiasIni, DiasFin)
        Catch ExceptionErr As Exception
            Throw New System.Exception(ExceptionErr.Message, _
                ExceptionErr.InnerException)
        End Try
