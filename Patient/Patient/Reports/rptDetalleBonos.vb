...
Public Class rptDetalleBonos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema.rptDetalleBonos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDetalleBonos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDetalleBonos = New rptDetalleBonos
        rpt.Site = Me.Site
        Return rpt
    End Function
