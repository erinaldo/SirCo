...
Public Class rptSovranteInv
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIRCO.rptSovranteInv.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSovranteInv
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSovranteInv = New rptSovranteInv()
        rpt.Site = Me.Site
        Return rpt
    End Function
