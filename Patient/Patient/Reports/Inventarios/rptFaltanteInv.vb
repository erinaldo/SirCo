...
Public Class rptFaltanteInv
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIRCO.rptFaltanteInv.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFaltanteInv
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFaltanteInv = New rptFaltanteInv()
        rpt.Site = Me.Site
        Return rpt
    End Function
