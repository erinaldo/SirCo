...
Public Class rptPpalCorteFolios
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIRCO.rptPpalCorteFolios.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPpalCorteFolios
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPpalCorteFolios = New rptPpalCorteFolios()
        rpt.Site = Me.Site
        Return rpt
    End Function
