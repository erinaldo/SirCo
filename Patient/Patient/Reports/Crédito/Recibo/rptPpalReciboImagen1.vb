...
Public Class rptPpalReciboImagen
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptPpalReciboImagen.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIRCO.rptPpalReciboImagen.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPpalReciboImagen
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPpalReciboImagen = New rptPpalReciboImagen()
        rpt.Site = Me.Site
        Return rpt
    End Function
