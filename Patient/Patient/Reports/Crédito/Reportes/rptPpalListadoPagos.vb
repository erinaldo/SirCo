...
Public Class rptPpalListadoPagos
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptPpalListadoPagos.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIRCO.rptPpalListadoPagos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPpalListadoPagos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPpalListadoPagos = New rptPpalListadoPagos()
        rpt.Site = Me.Site
        Return rpt
    End Function
