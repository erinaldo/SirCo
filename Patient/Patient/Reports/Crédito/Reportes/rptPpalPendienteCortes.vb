...
Public Class rptPpalPendienteCortes
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptPpalPendienteCortes.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIRCO.rptPpalPendienteCortes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPpalPendienteCortes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPpalPendienteCortes = New rptPpalPendienteCortes()
        rpt.Site = Me.Site
        Return rpt
    End Function
