...
Public Class rptPpalDistribuidor
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptPpalDistribuidor.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIRCO.rptPpalDistribuidor.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPpalDistribuidor
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPpalDistribuidor = New rptPpalDistribuidor()
        rpt.Site = Me.Site
        Return rpt
    End Function
