...
Public Class rptValesCancelados
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIRCO.rptValesCancelados.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptValesCancelados
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptValesCancelados = New rptValesCancelados()
        rpt.Site = Me.Site
        Return rpt
    End Function
