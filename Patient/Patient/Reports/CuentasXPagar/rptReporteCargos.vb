...
Public Class rptReporteCargos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIRCO.rptReporteCargos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptReporteCargos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptReporteCargos = New rptReporteCargos()
        rpt.Site = Me.Site
        Return rpt
    End Function
