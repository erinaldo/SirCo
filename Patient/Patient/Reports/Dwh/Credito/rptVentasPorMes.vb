...
Public Class rptVentasPorMes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIRCO.rptVentasPorMes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptVentasPorMes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptVentasPorMes = New rptVentasPorMes()
        rpt.Site = Me.Site
        Return rpt
    End Function
