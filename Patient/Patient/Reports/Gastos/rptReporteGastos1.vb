...
Public Class rptReporteGastos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIRCO.rptReporteGastos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptReporteGastos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptReporteGastos = New rptReporteGastos()
        rpt.Site = Me.Site
        Return rpt
    End Function
