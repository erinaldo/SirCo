...
Public Class rptPedidosNegados
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIRCO.rptPedidosNegados.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPedidosNegados
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPedidosNegados = New rptPedidosNegados()
        rpt.Site = Me.Site
        Return rpt
    End Function
