...
Public Class rptReciboAguiBono
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIRCO.rptReciboAguiBono.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptReciboAguiBono
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptReciboAguiBono = New rptReciboAguiBono()
        rpt.Site = Me.Site
        Return rpt
    End Function
