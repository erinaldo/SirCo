...
Public Class rptAlcanceMetas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIRCO.rptAlcanceMetas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAlcanceMetas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAlcanceMetas = New rptAlcanceMetas()
        rpt.Site = Me.Site
        Return rpt
    End Function
