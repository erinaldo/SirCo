...
Public Class rptReciboNominaF
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIRCO.rptReciboNominaF.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptReciboNominaF
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptReciboNominaF = New rptReciboNominaF()
        rpt.Site = Me.Site
        Return rpt
    End Function
