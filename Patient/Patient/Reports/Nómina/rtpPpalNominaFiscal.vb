...
Public Class rtpPpalNominaFiscal
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rtpPpalNominaFiscal.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIRCO.rtpPpalNominaFiscal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrtpPpalNominaFiscal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rtpPpalNominaFiscal = New rtpPpalNominaFiscal()
        rpt.Site = Me.Site
        Return rpt
    End Function
