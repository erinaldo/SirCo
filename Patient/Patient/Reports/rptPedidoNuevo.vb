...
Public Class rptPedidoNuevo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIRCO.rptPedidoNuevo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPedidoNuevo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPedidoNuevo = New rptPedidoNuevo()
        rpt.Site = Me.Site
        Return rpt
    End Function
