...
Public Class rptArticulosRecibidos
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptArticulosRecibidos.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIRCO.rptArticulosRecibidos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptArticulosRecibidos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptArticulosRecibidos = New rptArticulosRecibidos
        rpt.Site = Me.Site
        Return rpt
    End Function
