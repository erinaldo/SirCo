...
Public Class rptPpalAparador
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIRCO.rptPpalAparador.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPpalAparador
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPpalAparador = New rptPpalAparador()
        rpt.Site = Me.Site
        Return rpt
    End Function
