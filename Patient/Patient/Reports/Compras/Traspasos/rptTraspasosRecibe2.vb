...
Public Class rptTraspasosRecibe
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIRCO.rptTraspasosRecibe.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTraspasosRecibe
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTraspasosRecibe = New rptTraspasosRecibe()
        rpt.Site = Me.Site
        Return rpt
    End Function
