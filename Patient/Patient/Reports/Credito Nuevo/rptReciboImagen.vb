...
Public Class rptReciboImagen
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIRCO.rptReciboImagen.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptReciboImagen
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptReciboImagen = New rptReciboImagen()
        rpt.Site = Me.Site
        Return rpt
    End Function
