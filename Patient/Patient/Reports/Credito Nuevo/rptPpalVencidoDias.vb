...
Public Class rptPpalVencidoDias
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIRCO.rptPpalVencidoDias.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPpalVencidoDias
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPpalVencidoDias = New rptPpalVencidoDias()
        rpt.Site = Me.Site
        Return rpt
    End Function
