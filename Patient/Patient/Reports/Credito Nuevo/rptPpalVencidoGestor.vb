...
Public Class rptPpalVencidoGestor
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptPpalVencidoGestor.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIRCO.rptPpalVencidoGestor.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPpalVencidoGestor
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPpalVencidoGestor = New rptPpalVencidoGestor()
        rpt.Site = Me.Site
        Return rpt
    End Function
