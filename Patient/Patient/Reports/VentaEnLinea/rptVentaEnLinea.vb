...
Public Class rptVentaEnLinea
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIRCO.rptVentaEnLinea.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptVentaEnLinea
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptVentaEnLinea = New rptVentaEnLinea()
        rpt.Site = Me.Site
        Return rpt
    End Function
