...
Public Class rptReporteCedi
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIRCO.rptReporteCedi.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptReporteCedi
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptReporteCedi = New rptReporteCedi()
        rpt.Site = Me.Site
        Return rpt
    End Function
