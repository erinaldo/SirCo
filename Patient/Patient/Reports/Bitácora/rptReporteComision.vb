...
Public Class rptReporteComision
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIRCO.rptReporteComision.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptReporteComision
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptReporteComision = New rptReporteComision()
        rpt.Site = Me.Site
        Return rpt
    End Function
