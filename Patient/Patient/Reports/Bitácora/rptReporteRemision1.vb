...
Public Class rptReporteRemision
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIRCO.rptReporteRemision.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptReporteRemision
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptReporteRemision = New rptReporteRemision()
        rpt.Site = Me.Site
        Return rpt
    End Function
