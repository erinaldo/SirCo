...
Public Class rptTraspasosRecyEnv
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptTraspasosRecyEnv.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIRCO.rptTraspasosRecyEnv.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTraspasosRecyEnv
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTraspasosRecyEnv = New rptTraspasosRecyEnv()
        rpt.Site = Me.Site
        Return rpt
    End Function
