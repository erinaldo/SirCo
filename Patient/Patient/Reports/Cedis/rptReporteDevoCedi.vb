...
Public Class rptReporteDevoCedi
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIRCO.rptReporteDevoCedi.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptReporteDevoCedi
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptReporteDevoCedi = New rptReporteDevoCedi()
        rpt.Site = Me.Site
        Return rpt
    End Function
