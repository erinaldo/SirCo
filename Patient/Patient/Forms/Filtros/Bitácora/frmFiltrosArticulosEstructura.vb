Public Class frmFiltrosArticulosEstructura
    'Tony García - 18/Mayo/2013 09:43 a.m.
    Dim Sql As String
    ...
    Private Sub Txt_Proveedor_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles Txt_Proveedor.LostFocus
        ...
        End Try
    End Sub
    Private Sub Txt_CostoIni_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles Txt_CostoIni.LostFocus
        Txt_CostoIni.Text = Format(Val(Txt_CostoIni.Text), "$###,##0.00")
        Txt_CostoFin.Text = Txt_CostoIni.Text
    End Sub
    Private Sub Txt_CostoFin_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles Txt_CostoFin.LostFocus
        Txt_CostoFin.Text = Format(Val(Txt_CostoFin.Text), "$###,##0.00")
    End Sub
    Private Sub Txt_PrecioIni_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles Txt_PrecioIni.LostFocus
        Txt_PrecioIni.Text = Format(Val(Txt_PrecioIni.Text), "$###,##0.00")
        Txt_PrecioFin.Text = Txt_PrecioIni.Text
    End Sub
    Private Sub Txt_PrecioFin_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles Txt_PrecioFin.LostFocus
    ...
    Private Sub Chk_UltRecibo_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Chk_UltRecibo.CheckedChanged
        ...
        End Try
    End Sub
    Private Sub Chk_Entrega_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles Chk_Entrega.CheckedChanged
        Try
            If Chk_Entrega.Checked = False Then
                DT_FecEntIni.Enabled = False
                DT_FecEntFin.Enabled = False
    ...
    Private Sub Rb_Nuevos_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles Rb_Nuevos.CheckedChanged
        Try
            If Rb_Nuevos.Checked = True Then
                Rb_Todos.Checked = False
