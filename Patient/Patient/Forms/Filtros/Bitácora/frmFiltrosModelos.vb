Public Class frmFiltrosModelos
    ...
    End Sub
    Private Sub Txt_Estilon_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles Txt_Modelo.LostFocus
    ...
    Private Sub Txt_Agrupacion_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles Txt_Agrupacion.LostFocus
        Try
            If Txt_Agrupacion.Text.Length = 0 Then Exit Sub
            If Txt_Agrupacion.Text.Trim.Length < 3 Then
                Txt_Agrupacion.Text = pub_RellenarIzquierda(Txt_Agrupacion.Text.Trim, 3)
            End If
            Call TxtLostfocus(Txt_Agrupacion, Txt_DescripAgrup, "AI")
        Catch ExceptionErr As Exception
            MessageBox.Show(ExceptionErr.Message.ToString)
        End Try
    End Sub
