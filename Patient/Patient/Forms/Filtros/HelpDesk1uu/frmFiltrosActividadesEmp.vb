    ...
    Private Sub usp_TraerEmpleadoRep()
        ...
        Using objEmpleado As New BCL.BCLCatalogoEmpleado(GLB_ConStringNomSis)
            Try
                ...
                objDataSet = objEmpleado.usp_TraerNomEmpleado(Val(Txt_IdReporta.Text), "", "", "", "")
                If objDataSet.Tables(0).Rows.Count > 0 Then
    ...
    Private Sub usp_TraerEmpleadoAsig()
        ...
        Using objEmpleado As New BCL.BCLCatalogoEmpleado(GLB_ConStringNomSis)
            Try
                ...
                objDataSet = objEmpleado.usp_TraerNomEmpleado(Val(Txt_IdAsignado.Text), "", "", "", "")
                If objDataSet.Tables(0).Rows.Count > 0 Then
