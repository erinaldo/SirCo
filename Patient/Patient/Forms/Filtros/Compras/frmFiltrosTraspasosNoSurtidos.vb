Public Class frmFiltrosTraspasosNoSurtidos
    'miguel pérez 13/Otubre/2012 07:45 p.m.
    Dim Sql As String
    ...
    Private Sub Btn_Aceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btn_Aceptar.Click
        Try
            If Chk_Fechas.Checked = False And Txt_Sucursal.Text = "" And Txt_Trasp1.Text = "" And Txt_Trasp2.Text = "" And Txt_NumSerie.Text = "" Then
                Sw_Filtro = False
            Else
                Sw_Filtro = True
            End If
