Public Class frmFiltrosEficienciaVend
    Dim Sql As String
    ...
    Private Sub Btn_Cancelar_BackColorChanged(sender As Object, e As EventArgs) Handles Btn_Cancelar.BackColorChanged

    End Sub

    Private Sub Btn_Cancelar_ChangeUICues(sender As Object, e As UICuesEventArgs) Handles Btn_Cancelar.ChangeUICues
    ...
    'Private Sub Txt_SucurOri_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs)
