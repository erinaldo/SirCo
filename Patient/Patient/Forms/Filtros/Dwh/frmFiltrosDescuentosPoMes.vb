Public Class frmFiltrosDescuentosPoMes
    Dim Sql As String
    ...
    Private Sub Chk_FechaTraspaso_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub DTPicker3_ValueChanged(sender As Object, e As EventArgs) Handles DTPicker3.ValueChanged
        DTPicker3.Enabled = True
    End Sub
End Class