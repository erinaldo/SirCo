Public Class frmFiltrosNegBodega
    'mreyes 18/Abril/2017   12:15 p.m.
...
#End Region
    ...
    Private Sub Chk_FechaTraspaso_CheckedChanged(sender As Object, e As EventArgs) Handles Chk_FechaTraspaso.CheckedChanged
