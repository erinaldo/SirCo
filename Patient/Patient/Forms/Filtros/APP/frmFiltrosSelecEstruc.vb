...
Public Class frmFiltrosSelecEstruc
    'mreyes 22/Septiembre/2017  06:27 p.m.
    ...
    Public Opcion As Integer = 1 ' valor 1, cuando es generación de estructura, valor 2 cuando es solo filtro
    ...
    Private Sub Btn_Aceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btn_Aceptar.Click
        ...
        'mreyes 23/Septiembre/2017  12:29 p.m.
        Try
            'proceso para actualizar la estructura, según lo seleccionado.
            If Opcion = 2 Then
                Try
                    Sw_Filtro = True
                    Me.Close()
            ...
            Else
                ...
                Using objBultos As New BCL.BCLTraspasosAutomaticos(GLB_ConStringSirCoAppSQL)
                    Guardo = objBultos.usp_Captura_Muestrasdet(2, 0, "", "", "", Val(Txt_IdDivision.Text), Txt_DescripDivision.Text, Val(Txt_IdDepto.Text), Txt_DescripDepto.Text, Val(Txt_IdFamilia.Text), Txt_DescripFamilia.Text, Val(Txt_IdLinea.Text), Txt_DescripLinea.Text, Val(Txt_IdL1.Text), Txt_DescripL1.Text, Val(Txt_IdL2.Text), Txt_DescripL2.Text, Val(Txt_IdL3.Text), Txt_DescripL3.Text, Val(Txt_IdL4.Text), Txt_DescripL4.Text, Val(Txt_IdL5.Text), Txt_DescripL5.Text, Val(Txt_IdL6.Text), Txt_DescripL6.Text, "", "", "", 0, 0, 0, arrImage, GLB_Idempleado)
                End Using
