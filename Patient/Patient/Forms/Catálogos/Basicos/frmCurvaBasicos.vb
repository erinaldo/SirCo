...
Public Class frmCurvaBasicos
    'mreyes 15/Enero/2019  12:02 p.m.
    ...
    Private Sub frmCatalogoEstilos_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            Me.Text = "Curva Modelo " & Txt_Marca.Text & " - " & Txt_Modelo.Text
    ...
    Private Sub Btn_ModAnterior_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Try
    ...
    Private Sub Btn_ModSiguiente_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Try
    ...
    Private Sub RellenaGrid()
        'mreyes 15/Enero/2019   03:58 p.m.
        Using objRegistro As New BCL.BCLTraspasosAutomaticos(GLB_ConStringSirCoSQL)
            ...
            Try
                ...
                objDataSet = objRegistro.usp_TraerCurva(Txt_Marca.Text, Txt_Modelo.Text)

                'Populate the Project Details section
                If objDataSet.Tables(0).Rows.Count > 0 Then
                    'Populate the Project Details section
                    If objDataSet.Tables(0).Rows(0).Item("frecuencia").ToString = "DIARIO" Then
                        Opt_Diario.Checked = True

                    End If

                    If objDataSet.Tables(0).Rows(0).Item("frecuencia").ToString = "SEMANAL" Then
                        Opt_Semanal.Checked = True
                        Cbo_Semanal.Text = objDataSet.Tables(0).Rows(0).Item("dia").ToString

                    End If


                    If objDataSet.Tables(0).Rows(0).Item("frecuencia").ToString = "QUINCENAL" Then
                        Opt_Quincenal.Checked = True
                        Cbo_Semanal.Text = objDataSet.Tables(0).Rows(0).Item("dia").ToString

                    End If


                    If objDataSet.Tables(0).Rows(0).Item("frecuencia").ToString = "MENSUAL" Then
                        Opt_Mensual.Checked = True
                        Cbo_Semanal.Text = objDataSet.Tables(0).Rows(0).Item("dia").ToString
                    End If

                    DT_FecFin.Text = objDataSet.Tables(0).Rows(0).Item("vigencia")

                    Txt_MinimoPares.Text = Val(objDataSet.Tables(0).Rows(0).Item("minimopares"))
    ...
    Private Sub InicializaGrid()
        Try
            ...
            DGrid.Columns(65).HeaderText = "Total"

            DGrid.Columns(66).HeaderText = "Vigencia"
            DGrid.Columns(67).HeaderText = "Frecuencia"
            DGrid.Columns(68).HeaderText = "Dia"
            DGrid.Columns(69).HeaderText = "NumeroPares"
            ...
            If Intervalo = "L" And Mid(MedMin, 1, 1) <> "0" Then
                ...
                For i As Integer = 22 To DGrid.ColumnCount - 1
                    DGrid.Columns(i).Visible = False
            ...
            Else
                ...
                For i As Integer = 3 To DGrid.ColumnCount - 1
                    DGrid.Columns(i).Visible = False
        ...
        Try
            ...
            For i As Integer = 0 To DGrid.Rows.Count - 1
                For j As Integer = 5 To DGrid.Columns.Count - 5
                    If DGrid.Columns(j).Visible = True Then
                        If DGrid.Rows(i).Cells(j).Value = "0" Then
                            ...
                            If DGrid.Rows(i).Cells("Det").Value.ToString.Trim = "01" Then

                                Col5 = Col1
                            ElseIf DGrid.Rows(i).Cells("Det").Value.ToString.Trim = "02" Then
                                Col5 = Col2
                            ElseIf DGrid.Rows(i).Cells("Det").Value.ToString.Trim = "06" Then
                                Col5 = Col3
                            ElseIf DGrid.Rows(i).Cells("Det").Value.ToString.Trim = "08" Then
                                Col5 = Col4
                            ElseIf DGrid.Rows(i).Cells("Det").Value.ToString.Trim = "11" Then
                                Col5 = Color.White
                            Else
                                Col5 = Color.White
                            End If
                ...
                If DGrid.Rows(i).Cells("Det").Value.ToString.Trim = "01" Then
                    ...
                    Continue For
                End If
                If DGrid.Rows(i).Cells("Det").Value.ToString.Trim = "02" Then
                    DGrid.Rows(i).DefaultCellStyle.BackColor = Col2
                    Continue For
                End If
                If DGrid.Rows(i).Cells("Det").Value.ToString.Trim = "06" Then
                    DGrid.Rows(i).DefaultCellStyle.BackColor = Col3
                    Continue For
                End If
                If DGrid.Rows(i).Cells("Det").Value.ToString.Trim = "08" Then
                    DGrid.Rows(i).DefaultCellStyle.BackColor = Col4
                    Continue For
                End If

                If DGrid.Rows(i).Cells("Det").Value.ToString.Trim = "11" Then
    ...
    Private Sub DGrid2_CellContentClick_1(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs)
    ...
    Private Sub DGrid_KeyDown(sender As Object, e As KeyEventArgs) Handles DGrid.KeyDown
        Try
            Dim selectedCellCount As Integer = DGrid.GetCellCount(DataGridViewElementStates.Selected)
            ...
            If (e.KeyCode = 46) Then
                ...
                DGrid.Rows(renglon).Cells(65).Value = pub_SumarRenglonGridSTotal(DGrid, renglon, Inicio, Fin)
    ...
    Private Function GuardarCurva() As Boolean
        'mreyes 15/Enero/2019   05:15   p.m.
        Try
            ...
            Dim Dia As String = ""
            Dim MinimoPares As Integer = Val(Txt_MinimoPares.Text)

            'PRIMERO CHECAR SI LA TIENDA TIENE LA MISMA EXISTENCIA, ENTONCES SE QUEDA .. DONDE MISMO.. 
            blnAbortar = False

            If Opt_Diario.Checked = True Then
                Frecuencia = "DIARIO"
            End If
            If Opt_Mensual.Checked = True Then
                Frecuencia = "MENSUAL"
                Dia = Cbo_Mensual.Text
            End If

            If Opt_Quincenal.Checked = True Then
                Frecuencia = "QUINCENAL"
                Dia = Cbo_Quincenal.Text
            End If
            If Opt_Semanal.Checked = True Then
                Frecuencia = "SEMANAL"
                Dia = Cbo_Semanal.Text
            End If
            ...
            For j As Integer = Inicio To Fin
                ...
                If blnAbortar = True Then Exit Function
                For I As Integer = 0 To DGrid.Rows.Count - 1
                    'SucurDes = DGrid.Columns(I).HeaderText
                    If blnAbortar = True Then Exit Function
                    '' IF PARA VER SI TIENE PROPUESTA... 
                    If DGrid.Rows(I).Cells(j).Value > 0 Then

                        If blnAbortar = True Then Exit Function
                        SucurDes = DGrid.Rows(I).Cells(0).Value
                        Medida = DGrid.Columns(j).HeaderText
                        CtdPropuesta = DGrid.Rows(I).Cells(j).Value
                        'CtdExi = DGridExistencia.Rows(0).Cells(j).Value
                        CtdTotal = 0

                        If blnAbortar = True Then Exit Function
                        'For x As Integer = 1 To DGrid.Rows.Count - 1
                        If blnAbortar = True Then Exit Function
                        '  sucurori = DGrid.Rows(x).Cells(0).Value

                        Using objBultos As New BCL.BCLTraspasosAutomaticos(GLB_ConStringSirCoSQL)
                            Guardo = objBultos.usp_Captura_CurvaIdeal(1, Txt_Marca.Text, Txt_Modelo.Text, DT_FecFin.Text, Medida, SucurDes, Frecuencia, Dia, MinimoPares, CtdPropuesta, GLB_Idempleado)
    ...
    Private Sub validar_Keypress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        ...
        Try
            ...
            'If DGrid.Rows(0).Cells(columna).Value = 0 Then
    ...
    Private Sub DGrid_CellBeginEdit(sender As Object, e As DataGridViewCellCancelEventArgs) Handles DGrid.CellBeginEdit
        Try
            Dim columna As Integer = DGrid.CurrentCell.ColumnIndex
            Dim renglon As Integer = DGrid.CurrentCell.RowIndex


            DGrid.Rows(renglon).Cells(columna).Style.ForeColor = Color.Black
    ...
    Private Sub DGrid_CellPainting(sender As Object, e As DataGridViewCellPaintingEventArgs) Handles DGrid.CellPainting
