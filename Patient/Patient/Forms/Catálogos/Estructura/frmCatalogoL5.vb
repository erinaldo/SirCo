Public Class frmCatalogoL5
    ...
    Function Inserta_SubSubSubSubLinea() As Boolean
        ...
        Using objCatalogoDeptos As New BCL.BCLEstructura(GLB_ConStringCipSis)
            ...
            Try
                'Add the Project
                If Not objCatalogoDeptos.usp_CapturaEstl5(CInt(Txt_IdDivisiones.Text), CInt(Txt_IdDepto.Text), CInt(Txt_IdFamilia.Text), CInt(Txt_IdLinea.Text), CInt(Txt_IdL1.Text), CInt(Txt_idL2.Text), CInt(Txt_IdL3.Text), CInt(Txt_IdL4.Text), Txt_CveL5.Text, Txt_DescripL5.Text) Then
                    Throw New Exception("Falló Inserción de Departamentos")
                Else
                    Inserta_SubSubSubSubLinea = True
                End If
    ...
    Function Actualiza_SubSubLinea() As Boolean
        'mreyes 04/Junio/2012 11:33 a.m.
        ...
        '    Try
        '        'Add the Project
        '        If Not objCatalogoDeptos.usp_ActualizarEstSubSubLinea(CInt(Txt_idSubSubLinea.Text), CInt(Txt_IdSubLinea.Text), (Txt_IdLinea.Text), CInt(Txt_IdFamilia.Text), CInt(Txt_IdDepto.Text), Txt_CveSubSubLinea.Text, Txt_DescripSubSubLinea.Text) Then
        '            Throw New Exception("Falló Inserción de Departamentos")
        '        Else
        '            Actualiza_SubSubLinea = True
        '        End If
        '    Catch ExceptionErr As Exception
        '        MessageBox.Show(ExceptionErr.Message.ToString)
        '    End Try
    ...
    Private Function ValidarEdicion() As Boolean
        ...
        Try
            ...
            If Txt_DescripL1.Text.Length = 0 Then
                MessageBox.Show("Debe especificar una SubLinea", "AVISO", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                Txt_CveL1.Focus()
                Exit Function
            End If

            If Txt_DescripL2.Text.Length = 0 Then
                MessageBox.Show("Debe especificar una SubSubLinea", "AVISO", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                Txt_CveL2.Focus()
                Exit Function
            End If

            If Txt_DescripL3.Text.Length = 0 Then
                MessageBox.Show("Debe especificar una descripción para la SubSubSubLinea", "AVISO", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                Txt_DescripL3.Focus()
                Exit Function
            End If

            If usp_ExisteSubSubSubSubLinea() = True Then
                MessageBox.Show("La Clave de la SubSubSubSubLinea ya existe", "AVISO", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                Txt_CveL3.Focus()
                Exit Function
            End If
    ...
    Private Sub Btn_Aceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btn_Aceptar.Click
        ...
        Try
            If Accion = 1 Then '''' es un articulo nuevo
                ...
                If MsgBox("Estas Seguro de Grabar la SubSubSubSubLinea?", MsgBoxStyle.OkCancel + MsgBoxStyle.Question, "Confirmar") = MsgBoxResult.Ok Then
                    If Inserta_SubSubSubSubLinea() = True Then

                        MessageBox.Show("SubSubSubSubLinea guardada correctamente", "AVISO", MessageBoxButtons.OK, MessageBoxIcon.Information)
                        Sw_Registro = True
                        Me.Close()
                        '' Me.Dispose()
                    Else
            ...
            ElseIf Accion = 2 Then ' es una actualización
                If ValidarEdicion() = False Then Exit Sub
                If MsgBox("Estas Seguro de Actualizar la SubSubLinea?", MsgBoxStyle.OkCancel + MsgBoxStyle.Question, "Confirmar") = MsgBoxResult.Ok Then
                    If Actualiza_SubSubLinea() = True Then

                        Sw_Registro = True
                        MessageBox.Show("SubSubLinea guardada correctamente", "AVISO", MessageBoxButtons.OK, MessageBoxIcon.Information)
                        Me.Close()
                        ' Me.Dispose()
                    Else
                        MessageBox.Show("Error Grabando !", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
    ...
    Private Sub frmCatalogoEstilos_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Accion = 1 Then
                ' LimpiarDatos()
            Else
                Call usp_TraerSubSubSubSubSubLinea()
    ...
    Private Sub usp_TraerSubSubSubSubSubLinea()
        ...
        Using objCatalogoDeptos As New BCL.BCLEstructura(GLB_ConStringCipSis)
            Try
                ...
                Else
                    Txt_IdL5.Text = 0
                End If
                objDataSet = objCatalogoDeptos.usp_TraerEstl5(CInt(Txt_IdL5.Text), 0, 0, 0, 0, 0, 0, 0, 0, Txt_CveL5.Text, 1, "")
                If objDataSet.Tables(0).Rows.Count > 0 Then
                    If Sw_Load = True Then
                        ...
                        Txt_CveL1.Text = objDataSet.Tables(0).Rows(0).Item("cvel1").ToString
                        Txt_DescripL1.Text = objDataSet.Tables(0).Rows(0).Item("l1").ToString
                        Txt_idL2.Text = objDataSet.Tables(0).Rows(0).Item("idl2").ToString
                        Txt_CveL2.Text = objDataSet.Tables(0).Rows(0).Item("cvel2").ToString
                        Txt_DescripL2.Text = objDataSet.Tables(0).Rows(0).Item("l2").ToString
                        Txt_IdL3.Text = objDataSet.Tables(0).Rows(0).Item("idl3").ToString
                        Txt_CveL3.Text = objDataSet.Tables(0).Rows(0).Item("cvel3").ToString
                        Txt_DescripL3.Text = objDataSet.Tables(0).Rows(0).Item("l3").ToString
                        Txt_IdL4.Text = objDataSet.Tables(0).Rows(0).Item("idl4").ToString
                        Txt_CveL4.Text = objDataSet.Tables(0).Rows(0).Item("cvel4").ToString
                        Txt_DescripL4.Text = objDataSet.Tables(0).Rows(0).Item("l4").ToString
                    End If
                    ...
                    Txt_CveL5.Text = objDataSet.Tables(0).Rows(0).Item("clave").ToString
                    Txt_DescripL5.Enabled = False
                Else
                    Txt_DescripL5.Enabled = True
                    Txt_DescripL5.Text = ""
                    Txt_DescripL5.Focus()
                End If
            Catch ExceptionErr As Exception
    ...
    Private Sub usp_TraerSubSubSubSubLinea()
        'mreyes 04/Junio/2012 12:04 p.m.
        ...
        Using objCatalogoDeptos As New BCL.BCLEstructura(GLB_ConStringCipSis)
            Try
                ...
                Else
                    Txt_IdL4.Text = 0
                End If
                objDataSet = objCatalogoDeptos.usp_TraerEstl4(CInt(Txt_IdL4.Text), CInt(Txt_IdL3.Text), CInt(Txt_idL2.Text), CInt(Txt_IdL1.Text), CInt(Txt_IdLinea.Text), CInt(Txt_IdFamilia.Text), CInt(Txt_IdDepto.Text), CInt(Txt_IdDivisiones.Text), Txt_CveL4.Text, 1, "")
                If objDataSet.Tables(0).Rows.Count > 0 Then
                    'Txt_IdDivisiones.Text = objDataSet.Tables(0).Rows(0).Item("iddivisiones").ToString
                    'Txt_CveDivisiones.Text = objDataSet.Tables(0).Rows(0).Item("cvedivisiones").ToString
                    'Txt_DescripDivisiones.Text = objDataSet.Tables(0).Rows(0).Item("divisiones").ToString
                    ...
                    Txt_IdL4.Text = objDataSet.Tables(0).Rows(0).Item("idl4").ToString
                    Txt_CveL4.Text = objDataSet.Tables(0).Rows(0).Item("clave").ToString
                ...
                Else
                    ...
                    myForm.IdSuperior7 = CInt(Txt_IdDivisiones.Text)
                    myForm.Opcion = 1
                    myForm.ShowDialog()
                    Txt_IdL4.Text = myForm.IdCampo
                    Txt_CveL4.Text = myForm.ClaveCampo
    ...
    Private Sub usp_TraerSubSubSubLinea()
        'mreyes 04/Junio/2012 12:04 p.m.
        ...
        Using objCatalogoDeptos As New BCL.BCLEstructura(GLB_ConStringCipSis)
            Try
                ...
                Else
                    Txt_IdL3.Text = 0
                End If
                objDataSet = objCatalogoDeptos.usp_TraerEstl3(CInt(Txt_IdL3.Text), CInt(Txt_idL2.Text), CInt(Txt_IdL1.Text), CInt(Txt_IdLinea.Text), CInt(Txt_IdFamilia.Text), CInt(Txt_IdDepto.Text), CInt(Txt_IdDivisiones.Text), Txt_CveL2.Text, 1, "")
                If objDataSet.Tables(0).Rows.Count > 0 Then
                    'Txt_IdDivisiones.Text = objDataSet.Tables(0).Rows(0).Item("iddivisiones").ToString
                    'Txt_CveDivisiones.Text = objDataSet.Tables(0).Rows(0).Item("cvedivisiones").ToString
                    'Txt_DescripDivisiones.Text = objDataSet.Tables(0).Rows(0).Item("divisiones").ToString
                    ...
                    'Txt_DescripSubLinea.Text = objDataSet.Tables(0).Rows(0).Item("SubLinea").ToString
                    Txt_IdL3.Text = objDataSet.Tables(0).Rows(0).Item("idl3").ToString
                    Txt_CveL3.Text = objDataSet.Tables(0).Rows(0).Item("clave").ToString
                ...
                Else
                    ...
                    myForm.IdSuperior6 = CInt(Txt_IdDivisiones.Text)
                    myForm.Opcion = 1
                    myForm.ShowDialog()
                    Txt_IdL3.Text = myForm.IdCampo
                    Txt_CveL3.Text = myForm.ClaveCampo
        ...
        Using objCatalogoDeptos As New BCL.BCLEstructura(GLB_ConStringCipSis)
            Try
                ...
                Else
                    Txt_idL2.Text = 0
                End If
                objDataSet = objCatalogoDeptos.usp_TraerEstl2(CInt(Txt_idL2.Text), CInt(Txt_IdL1.Text), CInt(Txt_IdLinea.Text), CInt(Txt_IdFamilia.Text), CInt(Txt_IdDepto.Text), CInt(Txt_IdDivisiones.Text), Txt_CveL2.Text, 1, "")
                If objDataSet.Tables(0).Rows.Count > 0 Then
                    'Txt_IdDivisiones.Text = objDataSet.Tables(0).Rows(0).Item("iddivisiones").ToString
                    'Txt_CveDivisiones.Text = objDataSet.Tables(0).Rows(0).Item("cvedivisiones").ToString
                    'Txt_DescripDivisiones.Text = objDataSet.Tables(0).Rows(0).Item("divisiones").ToString
                    ...
                    'Txt_DescripSubLinea.Text = objDataSet.Tables(0).Rows(0).Item("SubLinea").ToString
                    Txt_idL2.Text = objDataSet.Tables(0).Rows(0).Item("idl2").ToString
                    Txt_CveL2.Text = objDataSet.Tables(0).Rows(0).Item("clave").ToString
                ...
                Else
                    ...
                    Txt_CveL2.Text = myForm.ClaveCampo
        ...
        Using objCatalogoDeptos As New BCL.BCLEstructura(GLB_ConStringCipSis)
            Try
                If Txt_IdL1.Text.Trim = "" Then
                    Txt_IdL1.Text = 0
                End If
                objDataSet = objCatalogoDeptos.usp_TraerEstl1(CInt(Txt_IdL1.Text), CInt(Txt_IdLinea.Text), CInt(Txt_IdFamilia.Text), CInt(Txt_IdDepto.Text), CInt(Txt_IdDivisiones.Text), Txt_CveL1.Text, 1, "")
                If objDataSet.Tables(0).Rows.Count > 0 Then
                    'Txt_IdDepto.Text = objDataSet.Tables(0).Rows(0).Item("iddepto").ToString
                    'Txt_DescripDepto.Text = objDataSet.Tables(0).Rows(0).Item("depto").ToString
                    'Txt_Clave.Text = objDataSet.Tables(0).Rows(0).Item("cvedepto").ToString
    ...
    Private Function usp_ExisteSubSubSubSubLinea() As Boolean
        'mreyes 04/Junio/2012 12:04 p.m.
        ...
        Using objCatalogoDeptos As New BCL.BCLEstructura(GLB_ConStringCipSis)
            Try
                If Txt_IdL5.Text.Trim = "" Then
                    Txt_IdL5.Text = 0
                End If
                objDataSet = objCatalogoDeptos.usp_TraerEstl5(0, CInt(Txt_IdL4.Text), 0, 0, 0, 0, 0, 0, 0, Txt_CveL5.Text, 1, "")
                If objDataSet.Tables(0).Rows.Count > 0 Then
                    Return True
                Else
                    Return False
    ...
    Private Sub Txt_CveSubLinea_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Txt_CveL1.KeyPress
        Try
            e.KeyChar = UCase(e.KeyChar)
    ...
    Private Sub Txt_CveSubLinea_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Txt_CveL1.TextChanged
        Try
            If Sw_Load = True Then Exit Sub
            Txt_idL2.Text = ""
            Txt_CveL2.Text = ""
    ...
    Private Sub Txt_ClaveSubSubLinea_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Txt_CveL2.LostFocus
        Try
            If Txt_CveL2.Text.Trim = "" Then Exit Sub
    ...
    Private Sub Txt_ClaveSubSubSubLinea_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Txt_CveL3.LostFocus
        Try
            If Txt_CveL3.Text.Trim = "" Then Exit Sub
            usp_TraerSubSubSubLinea()
        Catch ExceptionErr As Exception
            MessageBox.Show(ExceptionErr.Message.ToString)
        End Try
    End Sub

    Private Sub Txt_ClaveSubSubSubSubLinea_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Txt_CveL4.LostFocus
        Try
            If Txt_CveL4.Text.Trim = "" Then Exit Sub
            usp_TraerSubSubSubSubLinea()
        Catch ExceptionErr As Exception
            MessageBox.Show(ExceptionErr.Message.ToString)
        End Try
    End Sub

    Private Sub Txt_ClaveSubSubSubSubSubLinea_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Txt_CveL5.LostFocus
        Try
            If Txt_CveL5.Text.Trim = "" Then Exit Sub
            usp_TraerSubSubSubSubSubLinea()
        Catch ExceptionErr As Exception
            MessageBox.Show(ExceptionErr.Message.ToString)
        End Try
    End Sub
    ...
    Private Sub Txt_CveSubSubSubSubLinea_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Txt_CveL5.KeyPress
        Try
            e.KeyChar = UCase(e.KeyChar)
            ...
            If e.KeyChar = ChrW(Keys.Enter) Then
                ...
                myForm.IdSuperior4 = 0
                myForm.IdSuperior5 = 0
                myForm.IdSuperior6 = 0
                myForm.IdSuperior7 = 0
                myForm.IdSuperior8 = 0
                myForm.Opcion = 2
                myForm.ShowDialog()
                Txt_IdL5.Text = myForm.IdCampo
                Txt_CveL5.Text = myForm.ClaveCampo
