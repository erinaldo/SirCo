Public Class frmCatalogoL3
    ...
    Function Inserta_SubSubSubLinea() As Boolean
        ...
        Using objCatalogoDeptos As New BCL.BCLEstructura(GLB_ConStringCipSis)
            ...
            Try
                'Add the Project
                If Not objCatalogoDeptos.usp_CapturaEstl3(CInt(Txt_IdDivisiones.Text), CInt(Txt_IdDepto.Text), CInt(Txt_IdFamilia.Text), CInt(Txt_IdLinea.Text), CInt(Txt_IdL1.Text), CInt(Txt_idL2.Text), Txt_CveL3.Text, Txt_DescripL3.Text) Then
                    Throw New Exception("Falló Inserción de Departamentos")
                Else
                    Inserta_SubSubSubLinea = True
                End If
    ...
    Private Function ValidarEdicion() As Boolean
        ...
        Try
            ...
            If usp_ExisteSubSubSubLinea() = True Then
                MessageBox.Show("La Clave de la SubSubSubLinea ya existe", "AVISO", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                Txt_CveL3.Focus()
                Exit Function
            End If
    ...
    Private Sub Btn_Aceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btn_Aceptar.Click
        ...
        Try
            If Accion = 1 Then '''' es un articulo nuevo
                ...
                If MsgBox("Estas Seguro de Grabar la SubSubSubLinea?", MsgBoxStyle.OkCancel + MsgBoxStyle.Question, "Confirmar") = MsgBoxResult.Ok Then
                    If Inserta_SubSubSubLinea() = True Then

                        MessageBox.Show("SubSubSubLinea guardada correctamente", "AVISO", MessageBoxButtons.OK, MessageBoxIcon.Information)
                        Sw_Registro = True
                        Me.Close()
                        '' Me.Dispose()
                    Else
        ...
        Using objCatalogoDeptos As New BCL.BCLEstructura(GLB_ConStringCipSis)
            Try
                ...
                Else
                    Txt_IdL3.Text = 0
                End If
                objDataSet = objCatalogoDeptos.usp_TraerEstl3(CInt(Txt_IdL3.Text), 0, 0, 0, 0, 0, 0, Txt_CveL3.Text, 1, "")
                If objDataSet.Tables(0).Rows.Count > 0 Then
                    ...
                    Txt_DescripL3.Enabled = False
                Else
                    Txt_DescripL3.Enabled = True
                    Txt_DescripL3.Text = ""
                    Txt_DescripL3.Focus()
                End If
            Catch ExceptionErr As Exception
    ...
    Private Function usp_ExisteSubSubSubLinea() As Boolean
        'mreyes 04/Junio/2012 12:04 p.m.
        ...
        Using objCatalogoDeptos As New BCL.BCLEstructura(GLB_ConStringCipSis)
            Try
                If Txt_IdL3.Text.Trim = "" Then
                    Txt_IdL3.Text = 0
                End If
                objDataSet = objCatalogoDeptos.usp_TraerEstl3(0, CInt(Txt_idL2.Text), 0, 0, 0, 0, 0, Txt_CveL3.Text, 1, "")
                If objDataSet.Tables(0).Rows.Count > 0 Then
                    Return True
                Else
                    Return False
    ...
    Private Sub Txt_CveSubSubSubLinea_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Txt_CveL3.KeyPress
        Try
            e.KeyChar = UCase(e.KeyChar)
