Public Class frmCatalogoDepartamento
    ...
    Function Inserta_Deptos() As Boolean
        ...
        Using objCatalogoDeptos As New BCL.BCLEstructura(GLB_ConStringCipSis)
            ...
            Try
                'Add the Project
                If Not objCatalogoDeptos.usp_CapturaEstDepto(CInt(Txt_IdDivisiones.Text), Txt_Clave.Text, Txt_DescripDepto.Text) Then
    ...
    Private Function ValidarEdicion() As Boolean
        ...
        Try
            If Txt_DescripDivisiones.Text.Length = 0 Then
                MsgBox("Debe especificar una división.", MsgBoxStyle.Critical, "Validación")
                Txt_CveDivisiones.Focus()
                Exit Function
            End If

            If Txt_DescripDepto.Text.Length = 0 Then
                MsgBox("Debe especificar una descripción para el departamento.", MsgBoxStyle.Critical, "Validación")
                Txt_DescripDepto.Focus()
                Exit Function
            End If

            If usp_ExisteDepartamento() = True Then
    ...
    Private Function usp_ExisteDepartamento() As Boolean
        ...
        Using objCatalogoDeptos As New BCL.BCLEstructura(GLB_ConStringCipSis)
            Try
                ...
                '    Txt_IdLinea.Text = 0
                'End If
                objDataSet = objCatalogoDeptos.usp_TraerEstDepto(0, CInt(Txt_IdDivisiones.Text), Txt_Clave.Text, 1, "")
        ...
        Using objCatalogoDeptos As New BCL.BCLEstructura(GLB_ConStringCipSis)
            Try
                ...
                If objDataSet.Tables(0).Rows.Count > 0 Then
                    ...
                    Txt_DescripDepto.Enabled = False
                Else
                    Txt_DescripDepto.Enabled = True
    ...
    Private Sub Txt_ClaveDepartamento_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Txt_Clave.LostFocus
        Try
    ...
    Private Sub Txt_CveDepartamento_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Txt_Clave.KeyPress
        Try
            e.KeyChar = UCase(e.KeyChar)
