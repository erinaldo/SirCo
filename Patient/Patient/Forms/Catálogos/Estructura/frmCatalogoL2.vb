Public Class frmCatalogoL2
    ...
    Function Inserta_SubSubLinea() As Boolean
        ...
        Using objCatalogoDeptos As New BCL.BCLEstructura(GLB_ConStringCipSis)
            ...
            Try
                'Add the Project
                If Not objCatalogoDeptos.usp_CapturaEstl2(CInt(Txt_IdDivisiones.Text), CInt(Txt_IdDepto.Text), CInt(Txt_IdFamilia.Text), CInt(Txt_IdLinea.Text), CInt(Txt_IdL1.Text), Txt_CveL2.Text, Txt_DescripL2.Text) Then
                    Throw New Exception("Falló Inserción de Departamentos")
                Else
                    Inserta_SubSubLinea = True
                End If
    ...
    Private Function ValidarEdicion() As Boolean
        ...
        Try
            ...
            If Txt_DescripL2.Text.Length = 0 Then
                MessageBox.Show("Debe especificar una descripción para la SubSubLinea", "AVISO", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                Txt_DescripL2.Focus()
                Exit Function
            End If

            If usp_ExisteSubSubLinea() = True Then
                MessageBox.Show("La Clave de la SubSubLinea ya existe", "AVISO", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                Txt_CveL2.Focus()
                Exit Function
            End If
    ...
    Private Sub Btn_Aceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btn_Aceptar.Click
        ...
        Try
            If Accion = 1 Then '''' es un articulo nuevo
                ...
                If MsgBox("Estas Seguro de Grabar la SubSubLinea?", MsgBoxStyle.OkCancel + MsgBoxStyle.Question, "Confirmar") = MsgBoxResult.Ok Then
                    If Inserta_SubSubLinea() = True Then
        ...
        Using objCatalogoDeptos As New BCL.BCLEstructura(GLB_ConStringCipSis)
            Try
                ...
                Else
                    Txt_idL2.Text = 0
                End If
                objDataSet = objCatalogoDeptos.usp_TraerEstl2(CInt(Txt_idL2.Text), 0, 0, 0, 0, 0, Txt_CveL2.Text, 1, "")
                If objDataSet.Tables(0).Rows.Count > 0 Then
                    ...
                    Txt_DescripL2.Enabled = False
                Else
                    Txt_DescripL2.Enabled = True
                    Txt_DescripL2.Text = ""
                    Txt_DescripL2.Focus()
                End If
            Catch ExceptionErr As Exception
    ...
    Private Function usp_ExisteSubSubLinea() As Boolean
        'mreyes 04/Junio/2012 12:04 p.m.
        ...
        Using objCatalogoDeptos As New BCL.BCLEstructura(GLB_ConStringCipSis)
            Try
                If Txt_idL2.Text.Trim = "" Then
                    Txt_idL2.Text = 0
                End If
                objDataSet = objCatalogoDeptos.usp_TraerEstl2(0, CInt(Txt_IdL1.Text), 0, 0, 0, 0, Txt_CveL2.Text, 1, "")
                If objDataSet.Tables(0).Rows.Count > 0 Then
                    Return True
                Else
                    Return False
    ...
    Private Sub Txt_CveSubSubLinea_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Txt_CveL2.KeyPress
        Try
            e.KeyChar = UCase(e.KeyChar)
