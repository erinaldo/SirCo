Public Class frmCatalogoLinea
    ...
    Function Inserta_Linea() As Boolean
        ...
        Using objCatalogoDeptos As New BCL.BCLEstructura(GLB_ConStringCipSis)
            ...
            Try
                'Add the Project
                If Not objCatalogoDeptos.usp_CapturaEstLinea(CInt(Txt_IdDivisiones.Text), CInt(Txt_IdDepto.Text), CInt(Txt_IdFamilia.Text), Txt_CveLinea.Text, Txt_DescripLinea.Text) Then
    ...
    Function Actualiza_Linea() As Boolean
        'mreyes 04/Junio/2012 11:33 a.m.
        ...
        Using objCatalogoDeptos As New BCL.BCLEstructura(GLB_ConStringCipSis)
            ...
            Try
                'Add the Project
                If Not objCatalogoDeptos.usp_ActualizarEstLinea(CInt(Txt_IdLinea.Text), CInt(Txt_IdFamilia.Text), CInt(Txt_IdDepto.Text), Txt_CveLinea.Text, Txt_DescripLinea.Text) Then
                    Throw New Exception("Falló Inserción de Departamentos")
                Else
    ...
    Private Function ValidarEdicion() As Boolean
        ...
        Try
            ...
            If Txt_DescripLinea.Text.Length = 0 Then
                MessageBox.Show("Debe especificar una descripción para la Linea", "AVISO", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                Txt_DescripLinea.Focus()
                Exit Function
            End If

            If usp_ExisteLinea() = True Then
                MessageBox.Show("La Clave de la Linea ya existe", "AVISO", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                Txt_CveLinea.Focus()
                Exit Function
            End If
    ...
    Private Sub Btn_Aceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btn_Aceptar.Click
        ...
        Try
            If Accion = 1 Then '''' es un articulo nuevo
                ...
                If MsgBox("Estas Seguro de Grabar la Linea?", MsgBoxStyle.OkCancel + MsgBoxStyle.Question, "Confirmar") = MsgBoxResult.Ok Then
                    If Inserta_Linea() = True Then

                        MessageBox.Show("Linea guardada correctamente", "AVISO", MessageBoxButtons.OK, MessageBoxIcon.Information)
                        Sw_Registro = True
                        Me.Close()
                        '' Me.Dispose()
                    Else
            ...
            ElseIf Accion = 2 Then ' es una actualización
                If ValidarEdicion() = False Then Exit Sub
                If MsgBox("Estas Seguro de Actualizar la Linea?", MsgBoxStyle.OkCancel + MsgBoxStyle.Question, "Confirmar") = MsgBoxResult.Ok Then
                    If Actualiza_Linea() = True Then
        ...
        Using objCatalogoDeptos As New BCL.BCLEstructura(GLB_ConStringCipSis)
            Try
                ...
                Else
                    Txt_IdLinea.Text = 0
                End If
                objDataSet = objCatalogoDeptos.usp_TraerEstLinea(CInt(Txt_IdLinea.Text), 0, 0, 0, Txt_CveLinea.Text, 1, "")
    ...
    Private Function usp_ExisteLinea() As Boolean
        'mreyes 04/Junio/2012 12:04 p.m.
        ...
        Using objCatalogoDeptos As New BCL.BCLEstructura(GLB_ConStringCipSis)
            Try
                ...
                '    Txt_IdLinea.Text = 0
                'End If
                objDataSet = objCatalogoDeptos.usp_TraerEstLinea(0, CInt(Txt_IdFamilia.Text), CInt(Txt_IdDepto.Text), CInt(Txt_IdDivisiones.Text), Txt_CveLinea.Text, 1, "")
                If objDataSet.Tables(0).Rows.Count > 0 Then
                    Return True
                Else
                    Return False
    ...
    Private Sub Txt_CveFamilia_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Txt_CveFam.KeyPress
        Try
            e.KeyChar = UCase(e.KeyChar)
    ...
    Private Sub Txt_CveLinea_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Txt_CveLinea.KeyPress
        Try
            e.KeyChar = UCase(e.KeyChar)
