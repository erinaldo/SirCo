Public Class frmCatalogoL4
    ...
    Function Inserta_SubSubSubSubLinea() As Boolean
        ...
        Using objCatalogoDeptos As New BCL.BCLEstructura(GLB_ConStringCipSis)
            ...
            Try
                'Add the Project
                If Not objCatalogoDeptos.usp_CapturaEstl4(CInt(Txt_IdDivisiones.Text), CInt(Txt_IdDepto.Text), CInt(Txt_IdFamilia.Text), CInt(Txt_IdLinea.Text), CInt(Txt_IdL1.Text), CInt(Txt_idL2.Text), CInt(Txt_IdL3.Text), Txt_CveL4.Text, Txt_DescripL4.Text) Then
    ...
    Private Sub frmCatalogoEstilos_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Accion = 1 Then
                ' LimpiarDatos()
            Else
                Call usp_TraerSubSubSubSubLinea()
        ...
        Using objCatalogoDeptos As New BCL.BCLEstructura(GLB_ConStringCipSis)
            Try
                ...
                Else
                    Txt_IdL4.Text = 0
                End If
                objDataSet = objCatalogoDeptos.usp_TraerEstl4(CInt(Txt_IdL4.Text), 0, 0, 0, 0, 0, 0, 0, Txt_CveL4.Text, 1, "")
                If objDataSet.Tables(0).Rows.Count > 0 Then
                    ...
                    Txt_DescripL4.Enabled = False
                Else
                    Txt_DescripL4.Enabled = True
                    Txt_DescripL4.Text = ""
                    Txt_DescripL4.Focus()
                End If
            Catch ExceptionErr As Exception
        ...
        Using objCatalogoDeptos As New BCL.BCLEstructura(GLB_ConStringCipSis)
            Try
                If Txt_IdL4.Text.Trim = "" Then
                    Txt_IdL4.Text = 0
                End If
                objDataSet = objCatalogoDeptos.usp_TraerEstl4(0, CInt(Txt_IdL3.Text), 0, 0, 0, 0, 0, 0, Txt_CveL4.Text, 1, "")
                If objDataSet.Tables(0).Rows.Count > 0 Then
                    Return True
                Else
                    Return False
    ...
    Private Sub Txt_CveSubSubSubSubLinea_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Txt_CveL4.KeyPress
        Try
            e.KeyChar = UCase(e.KeyChar)
