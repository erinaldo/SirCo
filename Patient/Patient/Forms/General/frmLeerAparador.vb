Public Class frmLeerAparador
    ...
    Private Sub Btn_Aceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btn_Aceptar.Click
        ...
        Try
            Sw_Filtro = True
            If MsgBox("Esta usted seguro de confirmar las series en aparador?.", MsgBoxStyle.YesNo + MsgBoxStyle.Question, "Confirmación") = MsgBoxResult.No Then Exit Sub
            ...
            For i As Integer = LBound(tArray) To UBound(tArray) 'Esas funciones recorren el array sin saber donde empieza ni donde acaba
                If Inserta_AparadorLeer(tArray(i)) = True Then
    ...
    Function Inserta_AparadorLeer(ByVal SerieB As String) As Boolean
        'mreyes 28/Abril/2015   10:28 a.m.

        Using objSigBit As New BCL.BCLAparador(GLB_ConStringCipSis)
            'Get a new Project DataSet
            Try
                objDataSet = objSigBit.Inserta_AparadorLeer
                ...
                'Add the Project
                If Not objSigBit.usp_Captura_AparadorLeer(objDataSet) Then
                    'Throw New Exception("Falló Inserción de Serie de AparadorLeer")
                Else
                    Inserta_AparadorLeer = True
                End If
