...
Public Class frmApendice
    ...
    '        End If
    '        Ticket1.TextoIzquierda(GLB_FechaHoy)
    '        Ticket1.TextoIzquierda("")
    ...
    '                            Ticket1.TextoIzquierda(objDataSet.Tables(0).Rows(i)(0) & "  " & objDataSet.Tables(0).Rows(i)(1) & "  " & pub_RellenarEspacios(objDataSet.Tables(0).Rows(i)(2), 3) & "  " & pub_RellenarEspacios(objDataSet.Tables(0).Rows(i)(3) & ".00", 9)) 'objDataSet.Tables(0).Rows(i)(3) & ".00")
    ...
    '        Ticket1.TextoIzquierda("                         ------  -------")
    '        Ticket1.TextoIzquierda("VENTA TOTAL :             " & pub_RellenarEspacios(num_total, 3) & " " & pub_RellenarEspacios(venta_total, 9))
    ...
    '                            Ticket1.TextoIzquierda("  " & pub_RellenarEspacios(objDataSet.Tables(0).Rows(i)(0), 10) & "  " & pub_RellenarEspacios(objDataSet.Tables(0).Rows(i)(1), 20))
    ...
    '                    Ticket1.TextoIzquierda("")
    '                    Ticket1.TextoIzquierda("           Deposito:    " & pub_RellenarEspacios(suma_efectivo.ToString, 10))
    '                    Ticket1.TextoIzquierda("")

    '                    For i As Integer = 0 To objDataSet.Tables(0).Rows.Count - 1
    '                        If objDataSet.Tables(0).Rows(i)(0) = "CHEQUE" Then
    '                            Ticket1.TextoIzquierda(objDataSet.Tables(0).Rows(i)(0) & "  " & pub_RellenarEspacios(objDataSet.Tables(0).Rows(i)(1), 20) & "  ")
    '                            total_pagos += CDbl(objDataSet.Tables(0).Rows(i)(1))
    '                            suma_efectivo += CDbl(objDataSet.Tables(0).Rows(i)(1))
    '                        End If
    ...
    '        End Using
    '        Ticket1.TextoIzquierda("                         " & "-----------")
    '        Ticket1.TextoIzquierda("TOTAL DE PAGOS RECIBIDOS:    " & total_pagos)
    '        Ticket1.TextoIzquierda("")
    ...
    '                Ticket1.TextoIzquierda("")
    '                Ticket1.TextoIzquierda("                   -----     --------")
    '                Ticket1.TextoIzquierda("TOTAL:            " & "    " & total_ctd_devoluciones & "        " & total_devoluciones & ".00")
    '            Catch ExceptionErr As Exception
    '                MessageBox.Show(ExceptionErr.Message.ToString)
    '            End Try
    '        End Using
    ...
    '        Ticket1.TextoIzquierda("Mca     Estilon    Med    Ctd  Impte.  T")
    '        Ticket1.TextoIzquierda("===     =======    ===    ===  ======  =")
    '        ''''''''''''''''''''''''''''''''''''''
    ...
    '                    For i As Integer = 0 To objDataSet.Tables(0).Rows.Count - 1
    '                        Ticket1.TextoIzquierda(objDataSet.Tables(0).Rows(i)(0) & "  " & objDataSet.Tables(0).Rows(i)(1) & "  " & objDataSet.Tables(0).Rows(i)(2) & "  " & objDataSet.Tables(0).Rows(i)(3) & "  " & objDataSet.Tables(0).Rows(i)(4) & "  " & "V") ' 
    ...
    '                Ticket1.TextoIzquierda("")
    '                Ticket1.TextoIzquierda("-----  --------   ")
    '                Ticket1.TextoIzquierda("+ Ventas     :        " & total_ctd_ventas & "  " & pub_RellenarEspacios(total_ventas, 6) & ".00   ")
    '                Ticket1.TextoIzquierda("- Devolucione:        " & total_ctd_devoluciones & "  " & pub_RellenarEspacios(total_devoluciones, 6) & ".00   ")
    '                Ticket1.TextoIzquierda("=====  =========   ")
    '                Ticket1.TextoIzquierda("= Ventas Netas:      " & total_ctd_ventas - total_ctd_devoluciones & "  " & pub_RellenarEspacios(total_ventas - total_devoluciones, 6) & ".00    ")
    ...
    '        Ticket1.TextoIzquierda("Corte de Caja: Suc. " & suc)
    '        Ticket1.TextoIzquierda("      del " & Format(fecha, "dd/MM/yyyy"))
    '        Ticket1.TextoIzquierda("      del cajero 01 al 99")
    ...
    '                            If objDataSet.Tables(0).Rows(i)(0).ToString = "=Tot " Then
    ...
    '                    For i As Integer = 0 To objDataSet.Tables(0).Rows.Count - 1
    '                        If objDataSet.Tables(0).Rows(i)(0) = "CHEQUE    " Then
    '                            Ticket1.TextoIzquierda("  " & pub_RellenarEspacios(objDataSet.Tables(0).Rows(i)(0), 10) & "  " & pub_RellenarEspacios(objDataSet.Tables(0).Rows(i)(1), 20) & ".00")
    '                            total_pagos += CDbl(objDataSet.Tables(0).Rows(i)(1))
    '                            suma_efectivo += CDbl(objDataSet.Tables(0).Rows(i)(1))
    '                        End If
    ...
    '                    Ticket1.TextoIzquierda("")
    '                    Ticket1.TextoIzquierda("           Deposito:    " & pub_RellenarEspacios(suma_efectivo.ToString, 10) & ".00")
    '                    Ticket1.TextoIzquierda("")
    ...
    '        End Using
    '        Ticket1.TextoIzquierda("                         " & "-----------")
    '        Ticket1.TextoIzquierda("TOTAL DE PAGOS RECIBIDOS:    " & total_pagos & ".00")
    '        Ticket1.TextoIzquierda("")
    ...
    '                Ticket1.TextoDerecha("+ Ventas     :        " & total_ctd_ventas & "  " & pub_RellenarEspacios(total_ventas, 6) & ".00   ")
    '                Ticket1.TextoDerecha("- Devolucione:        " & total_ctd_devoluciones & "  " & pub_RellenarEspacios(total_devoluciones, 6) & ".00   ")
    '                Ticket1.TextoDerecha("=====  =========   ")
    '                Ticket1.TextoDerecha("= Ventas Netas:      " & total_ctd_ventas - total_ctd_devoluciones & "  " & pub_RellenarEspacios(total_ventas - total_devoluciones, 6) & ".00    ")
    ...
    Private Sub mostrar_Tiquete_Apendice(ByVal suc As String, ByVal fecha As Date)
        Try
            ...
            add_this("Mca     Estilon    Med    Ctd  Impte.  T")
            add_this("===     =======    ===    ===  ======  =")
            ''''''''''''''''''''''''''''''''''''''
            Dim total_ctd_ventas As Integer = 0
            Dim total_ventas As Double = 0
            Using objDALActivos As New BCL.BCLApendice(GLB_ConStringCipSis)
                Try
                    ...
                    If objDataSet.Tables(0).Rows.Count > 0 Then
                        ...
                        For i As Integer = 0 To objDataSet.Tables(0).Rows.Count - 1
                            add_this(objDataSet.Tables(0).Rows(i)(0) & "  " & objDataSet.Tables(0).Rows(i)(1) & "  " & objDataSet.Tables(0).Rows(i)(2) & "  " & objDataSet.Tables(0).Rows(i)(3) & "  " & objDataSet.Tables(0).Rows(i)(4) & "  " & "V") ' 
                            total_ctd_ventas += objDataSet.Tables(0).Rows(i)(3)
                            total_ventas += objDataSet.Tables(0).Rows(i)(4)
                        Next
                    End If
                    ...
                    add_this("- Devolucione:        " & total_ctd_devoluciones & "  " & pub_RellenarEspacios(total_devoluciones, 6) & "      ")
                    add_this("=====  =========   ")
    ...
    Private Sub rb_porcentaje_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rb_porcentaje.CheckedChanged
    ...
    Private Sub rb_Importe_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rb_Importe.CheckedChanged
    ...
    Private Sub frmApendice_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        MessageBox.Show(RandomHoraCierre(30, 50))
    End Sub
    ...
    Private Sub txt_porcentaje_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txt_porcentaje.KeyPress
