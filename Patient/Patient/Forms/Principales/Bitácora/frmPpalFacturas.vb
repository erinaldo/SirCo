Public Class frmPpalFacturas
    'mreyes 15/Marzo/2012 04:16 p.m.
    ...
    Private Sub frmPpalFacturas_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            If Sw_FacturaNueva = True Then
                ...
                Btn_FactorajeSinLiquidación.Visible = False
                Btn_Factoraje.Visible = False
    ...
    Private Sub GenerarToolTip()
        Try
            ToolTip.SetToolTip(Btn_LiquidacionTransferencia, "Liquidación por Transferencia")
            ...
            If Sw_Remision = True Then
                ...
                ToolTip.SetToolTip(Btn_Recibido, "Recibido")
            Else
            ...
            ToolTip.SetToolTip(Btn_Factoraje, "Generar Factoraje de Facturas, mediante liquidación")
    ...
    Private Sub RellenaGrid(Optional ByVal Opcion1 As Integer = 0)
        Using objFactura As New BCL.BCLFacturas(GLB_ConStringCipSis)
            ...
            Try
                ...
                If Sw_Factoraje = True Then
                    objDataSet = objFactura.usp_PpalFacturasAFACTORAJE(Opcion, FactNueva, Sucursalb, IIf(FactInib = "F-" Or FactInib = "", "", "F-" & FactInib), IIf(FactFinb = "F-" Or FactFinb = "", "", "F-" & FactFinb), Marcab, _
                                                                       Proveedorb, sTATUSB1, FechaInib, _
                ...
                ElseIf Sw_PagoUnico = True Then
                    objDataSet = objFactura.usp_PpalFacturasINIPagoUnico(Opcion, FactNueva, Sucursalb, IIf(FactInib = "F-" Or FactInib = "", "", "F-" & FactInib), IIf(FactFinb = "F-" Or FactFinb = "", "", "F-" & FactFinb), Marcab, _
                                                                 Proveedorb, sTATUSB1, FechaInib, _
                                                                 FechaFinb, VenceInib, VenceFinb, FechaRecInib, FechaRecFinB, FechaPagoInib, FechaPagoFinB, FactProvInib, FactProvFinb, IdFolioIniB, IdFolioFinB, TipoB)
                ...
                Else
                    ...
                    If Sw_Remision = True Then
                        ...
                        objDataSet = objFactura.usp_PpalFacturasINI(Opcion, FactNueva, Sucursalb, IIf(FactInib = "R-" Or FactInib = "", "", "R-" & FactInib), IIf(FactFinb = "R-" Or FactFinb = "", "", "R-" & FactFinb), Marcab, _
                                                                           Proveedorb, sTATUSB1, FechaInib, _
                                                                       FechaFinb, VenceInib, VenceFinb, FechaRecInib, FechaRecFinB, FechaPagoInib, FechaPagoFinB, FactProvInib, FactProvFinb, IdFolioIniB, IdFolioFinB, TipoB)
                    Else
                        If Sw_FacturaNueva = True Then
                            objDataSet = objFactura.usp_PpalFacturasINI(Opcion, FactNueva, Sucursalb, IIf(FactInib = "F-" Or FactInib = "", "", "F-" & FactInib), IIf(FactFinb = "F-" Or FactFinb = "", "", "F-" & FactFinb), Marcab, _
                                                                               Proveedorb, sTATUSB1, FechaInib, _
    ...
    Sub InicializaGrid()
        ...
        Try
            ...
            DGrid.Columns(21).HeaderText = "Improcedente"
            ...
            If Sw_Remision = False And Sw_FacturaNueva = False Then
            ...
            DGrid.Columns("improcedente").DisplayIndex = 21
        Catch ExceptionErr As Exception
            MessageBox.Show(ExceptionErr.Message.ToString)
        End Try
    End Sub
        ...
        Try
            ...
            For i As Integer = 0 To objDataSet.Tables(0).Rows.Count - 1
                ...
                If DGrid.Rows(i).Cells("selecR").Value = True Then
                    ...
                    objDataRow1.Item("improcedente") = DGrid.Rows(i).Cells("improcedente").Value
        ...
        Using objFactura As New BCL.BCLFacturas(GLB_ConStringCipSis)
            Try
                ...
                If GLB_CveSucursal > "0" And GLB_CveSucursal < "90" Then
                    Sucursalb = GLB_CveSucursal
                End If
                objDataSet = objFactura.usp_PpalFacturasDet(1, Sucursalb, Marcab,
                                                                   Proveedorb,
    ...
    Private Sub Btn_FactorajeSinLiquidación_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btn_FactorajeSinLiquidación.Click
    ...
    Private Sub RellenaGridDIFERIDO(Optional ByVal Opcion1 As Integer = 0)
        ...
        Using objFactura As New BCL.BCLFacturas(GLB_ConStringCipSis)
            ...
            Try
                ...
                objDataSet = objFactura.usp_PpalFacturasDIFERIDOS(Opcion, FactNueva, Sucursalb, IIf(FactInib = "F-" Or FactInib = "", "", "F-" & FactInib), IIf(FactFinb = "F-" Or FactFinb = "", "", "F-" & FactFinb), Marcab,
                                                                   Proveedorb, sTATUSB1, FechaInib,
                                                                   FechaFinb, VenceInib, VenceFinb, FechaRecInib, FechaRecFinB, FechaPagoInib, FechaPagoFinB, FactProvInib, FactProvFinb, IdFolioIniB, IdFolioFinB, TipoB)
    ...
    Sub InicializaGridDIFERIDOS()
        ...
        Try
            ...
            If Reporte = 1 Or Statusb = "PAGADO" Then
                DGrid.Columns("SelecR").Visible = False
            End If
            DGrid.Columns("improcedente").DisplayIndex = 17
        Catch ExceptionErr As Exception
            MessageBox.Show(ExceptionErr.Message.ToString)
        End Try
    End Sub

    Private Sub Btn_LiquidacionTransferencia_Click(sender As Object, e As EventArgs) Handles Btn_LiquidacionTransferencia.Click
        Try
            Dim objDataRow1 As Data.DataRow
            ...
            Next
            If contChecks > 0 Then
                Dim myForm1 As New frmLiquidacionTransferencia
                myForm1.Remision = Sw_Remision
                myForm1.objDataSetLiquidacion = objDataSetLiquidacion
                myForm1.CBO_Cuentas.Visible = False
                myForm1.Label2.Visible = False
