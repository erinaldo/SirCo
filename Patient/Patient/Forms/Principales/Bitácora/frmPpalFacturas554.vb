Public Class frmPpalFacturas554
    'mreyes 27/Mayo/2015    10:11 a.m.
    ...
    Private Sub frmPpalFacturas_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            : Btn_Proveedor.Visible = False : Btn_Microsip.Visible = False
            ...
            If Sw_Load = True And Statusb = "PENDIENTE" Then
                ...
                Btn_Microsip.Visible = False

            Else

                FechaRecFinB = Format(Now.Date, "yyyy-MM-dd")
                FechaRecInib = Format("2015-02-18")
            End If
            If Reporte = 1 Then
    ...
    Private Sub GenerarToolTip()
        Try
            ...
            ToolTip.SetToolTip(Btn_Nuevo, "Nuevo Factura")
            ToolTip.SetToolTip(Btn_Editar, "Editar Factura")
            ToolTip.SetToolTip(Btn_Eliminar, "Eliminar Factura")
            ToolTip.SetToolTip(Btn_Consultar, "Consultar Factura")
            ToolTip.SetToolTip(Btn_Microsip, "Traspasar las facturas a microsip")
            ...
            If Sw_Remision = True Then
                ...
                ToolTip.SetToolTip(Btn_Recibido, "Pagar Comisión")
            Else
            ...
            ToolTip.SetToolTip(Btn_Liquidacion, "Generar liquidación de Proveedores")
            ToolTip.SetToolTip(Btn_Regresar, "Regresar")
            ToolTip.SetToolTip(Btn_Proveedor, "Agrupación por Proveedor")
            ToolTip.SetToolTip(Btn_Factoraje, "Generar Factoraje de Facturas")
    ...
    Private Sub RellenaGrid(Optional ByVal Opcion1 As Integer = 0)
        Using objFactura As New BCL.BCLFacturas(GLB_ConStringCipSis)
            ...
            Try
                ...
                objDataSet = objFactura.usp_PpalFacturas554(Opcion, FactNueva, Sucursalb, IIf(FactInib = "F-" Or FactInib = "", "", "F-" & FactInib), IIf(FactFinb = "F-" Or FactFinb = "", "", "F-" & FactFinb), Marcab, _
                                                                           Proveedorb, sTATUSB1, FechaInib, _
    ...
    Sub InicializaGrid()
        ...
        Try
            ...
            DGrid.Columns("comision").DisplayIndex = 11
            DGrid.Columns("comision").HeaderText = "Comision"
            ...
            'DGrid.Columns("comision").Frozen = True
            ...
            DGrid.Columns("comision").DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter
            ...
            DGrid.Columns("comision").DefaultCellStyle.BackColor = Color.PowderBlue
            ...
            DGrid.Columns(19).DisplayIndex = 8
            DGrid.Columns(19).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter

            If Statusb = "PAGADO" Then
                'DGrid.Columns(20).DisplayIndex = 9
                'DGrid.Columns(21).DisplayIndex = 10
                'DGrid.Columns(20).HeaderText = "IdLiq"
                'DGrid.Columns(21).HeaderText = "Fecha Pago"
                'DGrid.Columns(20).ReadOnly = True
                'DGrid.Columns(21).ReadOnly = True
    ...
    Private Sub Btn_Filtro_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btn_Filtro.Click
        ...
        Try
            ...
            myForm.Txt_Proveedor.Enabled = False
            ...
            If myForm.Chk_FechaRec.Checked = True Then
                ...
                myForm.DTPicker6.Enabled = False
    ...
    Private Sub NuevoPDToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub ConsultarBultoToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub ImprimirReporte()
        Try
            ...
            MsgBox("Recordar a Martha, para que lo haga")
            'Dim myForm As New frmReportsBrowser

            'myForm.objDataSetComision = GenerarReporte()
            'myForm.ReportIndex = 8455
            'myForm.Show()
    ...
    Private Sub Btn_Proveedor_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btn_Proveedor.Click
        ...
        Call RellenaGrid(3)
    End Sub
    ''Private Function GenerarReporte() As DSPComision
    ''    'Roberto 04/03/13
    ''    Try
    ''        GenerarReporte = New DSPComision
    ''        With DGrid
    ...
    Private Sub StandByToolStripMenuItem_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Try
    ...
    Private Sub Btn_Recibido_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Btn_Recibido.Click
        ...
        Try
            ...
            If MsgBox("Desea pagar la COMISION de las Facturas seleccionadas?", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "Confirmación") = MsgBoxResult.No Then Exit Sub
            For i As Integer = 0 To DGrid.Rows.Count - 1
                If DGrid.Rows(i).Cells("SelecR").Value = True Then
                    Using objCatCuentas As New BCL.BCLCatalogoCuentas(GLB_ConStringCipSis)
                        If Not objCatCuentas.usp_ActualizaPagoFactura(3, DGrid.Rows(i).Cells("idfoliosuc").Value.ToString.Trim(), "3", "", GLB_Idempleado) Then
            ...
            MsgBox("Actualizado correctamente.", MsgBoxStyle.Information, "Confirmación")
    ...
    Private Sub ConsultaMotivoToolStripMenuItem1_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Try
            Dim myForm As New frmMotivo
    ...
    Private Sub ConsultarNotaToolStripMenuItem1_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Try
    ...
    Private Sub VerPagoFichaToolStripMenuItem1_Click(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    Private Sub Btn_Liquidacion_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btn_Liquidacion.Click
        Try
    ...
    Private Sub ConsultarLiquidaciónToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Try
            If DGrid.Rows(DGrid.CurrentRow.Index).Cells("status").Value <> "PAGADO" Then
    ...
    Private Sub ConsultarDevoluciónToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Function GenerarReporte() As DSPLiquidacion
        'Roberto 04/03/13
        Try
            GenerarReporte = New DSPLiquidacion
            With DGrid
                For I As Integer = 1 To .Rows.Count - 2

                    If .Rows(I).Cells("SelecR").Value = True Then
                        Dim objDataRow As Data.DataRow = GenerarReporte.Tables(0).NewRow()
                        objDataRow.Item("factura") = .Rows(I).Cells("referenc").Value
                        objDataRow.Item("idfolio") = .Rows(I).Cells("idfoliosuc").Value
                        objDataRow.Item("NOPAGO") = .Rows(I).Cells("pares").Value

                        ' objDataRow.Item("fum") = .Rows(I).Cells(5).Value
                        objDataRow.Item("fecfact") = .Rows(I).Cells("fecha").Value
                        objDataRow.Item("fecha") = .Rows(I).Cells("fecvenc").Value

                        objDataRow.Item("proveedor") = .Rows(I).Cells("proveedor").Value
                        objDataRow.Item("subtotal") = .Rows(I).Cells("comision").Value

                        objDataRow.Item("total") = .Rows(I).Cells("importe").Value
    ...
    Private Sub Btn_Factoraje_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btn_Factoraje.Click
        Try
            ...
            For i As Integer = 0 To DGrid.Rows.Count - 1
                If DGrid.Rows(i).Cells("SelecR").Value = True Then
                    Using objCatCuentas As New BCL.BCLCatalogoCuentas(GLB_ConStringCipSis)
                        If Not objCatCuentas.usp_ActualizaPagoFactura(1, DGrid.Rows(i).Cells("idfoliosuc").Value.ToString.Trim(), "9", "", 0) Then
                            'Throw New Exception("No se pudo actualizar el Estatus.")
                        Else
                            'MsgBox("Estatus Actualizado correctamente.", MsgBoxStyle.Information, "Confirmación")
                        End If
