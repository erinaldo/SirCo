...
#Region "Metodos"
    ...
    Private Sub InicializaGrid()
        ...
        If chk_Miles.Checked Then
            gc_ImpNormal.Caption = "$ Vta Normal (En Miles)"
            gc_ImpDescto.Caption = "$ Vta Descto (En Miles)"
            gc_ImpReg.Caption = "$ Vta Regalo (En Miles)"
        ...
        Else
            gc_ImpNormal.Caption = "$ Vta Normal"
            gc_ImpDescto.Caption = "$ Vta Descto"
            gc_ImpReg.Caption = "$ Vta Regalo"
...
#Region "Eventos"
    ...
    Private Sub dgv_Reporte_PopupMenuShowing(sender As Object, e As PopupMenuShowingEventArgs) Handles dgv_Reporte.PopupMenuShowing
        Try
            Dim view As GridView = TryCast(sender, GridView)
    ...
    Private Sub dgv_Reporte_RowStyle(sender As Object, e As RowStyleEventArgs) Handles dgv_Reporte.RowStyle
        Try
    ...
    Private Sub dgv_Reporte_Click(sender As Object, e As EventArgs) Handles dgv_Reporte.Click
        Try
            If NivelAct <> "MODELO" Then
                PBox.Visible = False
                Exit Sub
    ...
    Private Sub dgv_Reporte_KeyUp(sender As Object, e As KeyEventArgs) Handles dgv_Reporte.KeyUp
        Try
            If NivelAct <> "MODELO" Then
                PBox.Visible = False
                Exit Sub
    ...
    Private Sub gc_Reporte_Click(sender As Object, e As EventArgs) Handles gc_Reporte.Click
