Public Class frmPpalAntiInventEstructura
    ...
    Private Sub frmPpalProveedores_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Sw_Load = True
        If GLB_Sw_Costos = False Then ToolStripMenuItemAnaModelo.Visible = False
        If GLB_Sw_Costos = False Then ToolStripMenuItemCatModelo.Visible = False
        ...
        If Sw_Mas250 = False Then
            ...
            End If
        Else
            Txt_DiasIni.Visible = True
            Txt_DiasFin.Visible = True

            Txt_DiasIni.Text = DiasIni
            Txt_DiasFin.Text = DiasFin
        ...
        If Accion = 2 Then
            Me.Text = "Inventario a Costo y Venta"
            chk_Costo.Visible = False
        End If
    End Sub
    ...
    Private Sub RellenaGrid()
        ...
        If Chk_Calzado.Checked Then
            Division = "CALZADO"
        End If
        If Chk_Sucursales.Checked = True Then
            MInicioB = "N"
        End If
        Me.Cursor = Cursors.WaitCursor
        ''
        Using objRegistro As New BCL.BCLAntiInvent(GLB_ConStringCipSis)
            objDataSet = objRegistro.usp_TraerBitacora(1, "", "1900-01-01", "1900-01-01")
        End Using
        If objDataSet.Tables(0).Rows.Count > 0 Then
            If objDataSet.Tables(0).Rows(0).Item("fin").ToString.Trim = "01/01/1900 12:00:00 a.m." Then
                Me.Cursor = Cursors.Default
                DGrid.DataSource = Nothing
                MessageBox.Show("La información se esta actualizando, por favor vuelve a intentar", "AVISO", MessageBoxButtons.OK, MessageBoxIcon.Information)
                blnActualizando = True
                Exit Sub
            End If
        End If
        If Accion = 1 Then
            Using objRegistro As New BCL.BCLAntiInvent(GLB_ConStringCipSis)
                objDataSet = objRegistro.usp_PpalInventarioTiendasEstructura(Opcion, Plaza, Sucursales(), Division, Depto, Familia, Linea, L1, L2, L3, L4, L5, L6, Marca, Modelo, DiasIni, DiasFin, Opcion2)
            End Using
            If objDataSet.Tables(0).Rows.Count > 0 Then
                DGrid.DataSource = Nothing
            ...
            Else
                ...
                Opcion = 13
                Using objRegistro As New BCL.BCLAntiInvent(GLB_ConStringCipSis)
                    objDataSet = objRegistro.usp_PpalInventarioTiendasEstructura(Opcion, Plaza, Sucursales(), Division, Depto, Familia, Linea, L1, L2, L3, L4, L5, L6, Marca, Modelo, 0, 0, Opcion2)
                End Using
                If objDataSet.Tables(0).Rows.Count > 0 Then
                    DGrid.DataSource = Nothing
                    DGrid.DataSource = objDataSet.Tables(0)
        ...
        End If
        If Accion = 2 Then
            If GLB_CveSucursal > "0" And GLB_CveSucursal < "12" Then
                Sucursal = GLB_CveSucursal
                Using objRegistro As New BCL.BCLAntiInvent(GLB_ConStringCipSis)
                    objDataSet = objRegistro.usp_TraerInventario(Opcion, Plaza, Sucursales(), Division, Depto, Familia, Linea, L1, L2, L3, L4, L5, L6, Marca, Modelo, strQueryInv, idAgrupacionB, MInicioB)
                End Using
            Else
                Using objRegistro As New BCL.BCLAntiInvent(GLB_ConStringCipSis)
                    objDataSet = objRegistro.usp_TraerInventario(Opcion, Plaza, Sucursales(), Division, Depto, Familia, Linea, L1, L2, L3, L4, L5, L6, Marca, Modelo, strQueryInv, idAgrupacionB, MInicioB)
    ...
    Public Function pub_SumarColumnaInventario(ByVal DGrid As DataGridView, ByVal Total As Decimal, ByVal Columna As String, ByVal Columna1 As String, Optional ByVal HastaRenglon As Integer = 0) As Decimal
        'mreyes 15/Marzo/2016   01:34 p.m.
        Try
            Dim Restar As Decimal = 0
            Dim Sumar As Decimal = 0


            Dim Col As Integer = DGrid.CurrentCell.ColumnIndex

            pub_SumarColumnaInventario = 0
            For renglon As Integer = 0 To IIf(HastaRenglon = 0, DGrid.RowCount - 2, HastaRenglon)

                If IsNumeric(DGrid.Rows(renglon).Cells(Columna).Value) Then 'si tiene valor
                    Restar = (DGrid.Rows(renglon).Cells(Columna1).Value) + Restar
                    Sumar = (DGrid.Rows(renglon).Cells(Columna).Value) + Sumar
            ...
            pub_SumarColumnaInventario = Total - Restar + Sumar
        Catch ExceptionErr As Exception
            MessageBox.Show(ExceptionErr.Message.ToString)
        End Try
    End Function
    ...
    Sub InicializaGrid()
        Try
            ...
            If Opcion = 1 Then
                DGrid.Columns("idplaza").HeaderText = "Plaza"
                DGrid.Columns("descripplaza").HeaderText = "Plaza"
            ...
            If Opcion = 1 Then
                ...
                DGrid.Columns("descripPlaza").Frozen = True
                DGrid.Columns("descripPlaza").DefaultCellStyle.BackColor = Color.PowderBlue
                DGrid.Columns("descripPlaza").DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter
                DGrid.Columns("descripPlaza").DefaultCellStyle.Font = New Font(DGrid.DefaultCellStyle.Font.FontFamily, DGrid.DefaultCellStyle.Font.Size, FontStyle.Bold)
            End If
    ...
    Sub InicializaGridInventario()
        Try
            Dim PrecDescSIVA As Decimal = 0
            Dim PrecDescCIVA As Decimal = 0
            ...
            row("costo") = pub_SumarColumnaGridNombre(DGrid, "costo", DGrid.RowCount - 1)
            row("precio") = pub_SumarColumnaGridNombre(DGrid, "precio", DGrid.RowCount - 1)
            row("costoC") = pub_SumarColumnaGridNombre(DGrid, "costoC", DGrid.RowCount - 1)
            row("precioC") = pub_SumarColumnaGridNombre(DGrid, "precioC", DGrid.RowCount - 1)
            PrecDescSIVA = pub_SumarColumnaGridNombre(DGrid, "precio", DGrid.RowCount - 1)
            PrecDescCIVA = pub_SumarColumnaGridNombre(DGrid, "precioC", DGrid.RowCount - 1)
            row("PrecdescsIVA") = pub_SumarColumnaGridNombre(DGrid, "PrecdescsIVA", DGrid.RowCount - 1)
            row("PrecdescCIVA") = pub_SumarColumnaGridNombre(DGrid, "PrecdescCIVA", DGrid.RowCount - 1)

            'row("PrecdescCIVA") = pub_SumarColumnaInventario(DGrid, PrecDescCIVA, "PrecdescCIVA", "precio", DGrid.RowCount - 1)
            'row("PrecdescSIVA") = pub_SumarColumnaInventario(DGrid, PrecDescSIVA, "PrecdescSIVA", "precio", DGrid.RowCount - 1)
            ...
            DGrid.Columns("costoc").HeaderText = "Costo C/IVA"
            DGrid.Columns("precioc").HeaderText = "Precio C/IVA"
            DGrid.Columns("PrecdescCIVA").HeaderText = "Precio Desc C/IVA"

            DGrid.Columns("costo").HeaderText = "Costo S/IVA"
            DGrid.Columns("precio").HeaderText = "Precio S/IVA"
            DGrid.Columns("PrecdescSIVA").HeaderText = "Precio Desc S/IVA"

            DGrid.Columns("costo").Visible = False
            DGrid.Columns("precio").Visible = False
            DGrid.Columns("precdescsiva").Visible = False



            If GLB_CveSucursal >= "0" And GLB_CveSucursal < "12" Then
                DGrid.Columns("costo").Visible = False
                DGrid.Columns("costoC").Visible = False
            End If
            ...
            DGrid.Columns("costo").DefaultCellStyle.Format = "c"
            DGrid.Columns("precio").DefaultCellStyle.Format = "c"
            DGrid.Columns("PrecdescsIVA").DefaultCellStyle.Format = "c"
            DGrid.Columns("PrecdescCIVA").DefaultCellStyle.Format = "c"
        ...
        Try
            ...
            If Opcion = 1 Then
                ...
                Else
                    ...
                    DescripPlaza = DGrid.CurrentRow.Cells("DescripPlaza").Value
                End If
        ...
        Try
            ...
            Else
                ...
                If objDataSet.Tables(0).Rows.Count > 0 Then
                    ...
                    '    For i As Integer = 0 To objDataSet.Tables(0).Rows.Count - 1
                    '        If objDataSet.Tables(0).Rows(i).Item("visible").ToString.Trim = "S" Then
                    '            If objDataSet.Tables(0).Rows(i).Item("sucursal").ToString.Trim <> "98" Then
                    '                strSuc += "('" + objDataSet.Tables(0).Rows(i).Item("sucursal").ToString.Trim + "'), "
                    '            End If
                    '        End If
                    '    Next
                    ...
                    Else
                        For i As Integer = 0 To objDataSet.Tables(0).Rows.Count - 1
                            If objDataSet.Tables(0).Rows(i).Item("minicio").ToString.Trim = "S" Then
                                strSuc += "('" + objDataSet.Tables(0).Rows(i).Item("sucursal").ToString.Trim + "'), "
                            End If
                        Next
                    End If
    ...
    Private Sub InventarioAnterior()
        Try
            strQueryInv = "INSERT INTO tbl_tempinv (idfecha, sucursal, marca, modelo, ctd, costotciva, ventatciva,  costotsiva, ventatsiva) " & vbCrLf & _
            "select e.idfecha, s.sucursal,e.marca,e.modelo,e.ctd,e.costot,e.ventat,e.costotsiva,e.ventatsiva from dwh.exist e " & vbCrLf & _
            "join dwh.fecha f " & vbCrLf & _
            "on f.idfecha = e.idfecha " & vbCrLf & _
            "join dwh.sucursal s " & vbCrLf & _
            "on s.idsucursal = e.idsucursal " & vbCrLf & _
            "where f.fecha = " + """" + FechaInv + """" + ";"
    ...
    'Private Sub RB_TodasSucursales_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
    '    Try
    '        If RB_TodasSucursales.Checked Then
    '            Sucursal = ""
    '            RellenaGrid()
    '        End If
    '    Catch ExceptionErr As Exception
    ...
    Private Sub GeneraTexto()
        If Plaza <> 0 Then
            lbl_Plaza.Text = DescripPlaza
        Else
            If RB_Activas.Checked Then
                lbl_Plaza.Text = "PLAZAS ACTIVAS"
            End If
            'If RB_SinLerdo.Checked Then
            '    lbl_Plaza.Text = "SUC. ACTIVAS SIN LERDO"
            'End If
            If Chk_Sucursales.Checked Then
        ...
        Else
            If RB_Activas.Checked Then
                lbl_Sucursal.Text = "SUCURSALES ACTIVAS"
            End If
            If RB_SinLerdo.Checked Then
                lbl_Sucursal.Text = "SUC. ACTIVAS"
            End If
            If Chk_Sucursales.Checked Then
    ...
    Private Sub Btn_Filtro_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btn_Filtro.Click
        Try
            ...
            myFormFiltros.DT_Fin.Visible = False
            myFormFiltros.DT_Inicio.Visible = True
            ...
            myFormFiltros.lbl_del.Visible = True
            myFormFiltros.lbl_del.Text = "Fecha:"
            If Accion = 1 Then
            ...
            If myFormFiltros.Sw_Filtro = True Then
                ...
                FechaInv = myFormFiltros.DT_Inicio.Value.ToString("yyyy-MM-dd")
    ...
    Private Sub OcultarToolStrips()
        If Opcion = 1 Then
            ToolStripMenuItemPlaza.Visible = False
        ...
        If Opcion = 2 Then 'SUCURSAL
            ToolStripMenuItemPlaza.Visible = True
    ...
    Private Sub Txt_DiasIni_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs)
        DiasIni = Txt_DiasIni.Text
    End Sub

    Private Sub Txt_DiasIni_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)

    End Sub

    Private Sub Txt_DiasFin_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs)
        DiasFin = Txt_DiasFin.Text
    End Sub

    Private Sub Txt_DiasFin_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub Txt_DiasFin_LostFocus1(ByVal sender As Object, ByVal e As System.EventArgs) Handles Txt_DiasFin.LostFocus
        DiasFin = Val(Txt_DiasFin.Text)
        Opcion = 13
        Accion = 1
        Sw_Mas250 = True
        Opcion2 = 1
    ...
    Private Sub Txt_DiasFin_TextChanged_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Txt_DiasFin.TextChanged

    End Sub

    Private Sub Txt_DiasIni_LostFocus1(ByVal sender As Object, ByVal e As System.EventArgs) Handles Txt_DiasIni.LostFocus
        DiasIni = Val(Txt_DiasIni.Text)
    End Sub

    Private Sub Txt_DiasIni_TextChanged_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Txt_DiasIni.TextChanged
    ...
    Private Sub lbl_Sucursal_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lbl_Sucursal.Click
    ...
    Private Sub GB_Sucursales_Enter(sender As Object, e As EventArgs) Handles GB_Sucursales.Enter
