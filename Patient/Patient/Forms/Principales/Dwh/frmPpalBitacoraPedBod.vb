Public Class frmPpalBitacoraPedBod
    ...
    Private Sub RellenaGrid()
        ...
        Using objTrasp As New BCL.BCLTraspasosSQL(GLB_ConStringSirCoSQL)
            ...
            Try
                ...
                objDataSet = objTrasp.usp_PpalBitacoraPedBod(DEFechaIni.EditValue, DEFechaFin.EditValue)
    ...
    Sub InicializaGrid()
        Try
            ...
            GridView2.Columns(1).Caption = "Ingreso"
            GridView2.Columns(2).Caption = "idempleado"
            GridView2.Columns(3).Caption = "Nombre"
            GridView2.Columns(4).Caption = "No Registrados"
