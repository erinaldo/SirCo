...
Public Class frmPpalPrevioVentaAnual
    ...
    Sub InicializaGrid()
        Try
            ...
            GridView1.Columns(4).Caption = "Corrida"
            GridView1.Columns(5).Caption = "Costo Margen"
            GridView1.Columns(6).Caption = "Precio Lleno"
            GridView1.Columns(7).Caption = "Precio Final"
            GridView1.Columns(8).Caption = "Existencia"
            GridView1.Columns(9).Caption = "Ult Fecha Recepción"
            GridView1.Columns(9).Width = 40
            GridView1.Columns(10).Caption = "Días Antigüedad"
            GridView1.Columns(11).Caption = "Imagen"
            GridView1.Columns(12).Caption = "Precio Nuevo"
            GridView1.Columns(13).Caption = "Margen %"
            GridView1.Columns(14).Caption = "Margen $"
            ...
            GridView1.Columns(7).AppearanceCell.Font = New Font(GridView1.Columns(7).AppearanceCell.Font, FontStyle.Bold)
            ...
            GridView1.Columns(14).AppearanceCell.ForeColor = Color.Green
    ...
    Private Sub RellenaGrid()
        ...
        Using objTrasp As New BCL.BCLVentaEnLinea(GLB_ConStringSirCoSQL)
            ...
            Try
                ...
                objDataSet = objTrasp.usp_PpalPrevioVentaAnualFoto(FechIniB, FechFinB, Marca, Modelo, Division, Depto, Linea, L1, L2, L3, L4, L5, L6)
