    ...
    Private Sub RellenaGrid()
        ...
        Using objTrasp As New BCL.BCLTraspasosAutomaticos(GLB_ConStringSirCoSQL)
            ...
            Try
                ...
                DGrid.Visible = False
                objDataSet = objTrasp.usp_PpalNegBodega(Sucursal, FechaIniB, FechaFinB, Division, Depto, Familia, Linea, L1, L2, L3, L4, L5, L6, Marca, Modelo, idagrupacion)
