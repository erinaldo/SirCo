Public Class frmPpalL4
    ...
    Dim CveSubSubSubSubLinea As String
    ...
    Private Sub frmPpalProveedores_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            Call RellenaGrid()
            Call GenerarToolTip()
            NuevoProveedorToolStripMenuItem.Text = "Agregar SubSubSubSubSubLinea"
            ConsultarProveedorToolStripMenuItem.Text = "Consultar SubSubSubSubLinea"
    ...
    Private Sub RellenaGrid()
        ...
        Using objCatalogoDeptos As New BCL.BCLEstructura(GLB_ConStringCipSis)
            ...
            Try
                ...
                objDataSet = objCatalogoDeptos.usp_TraerEstl4(0, Superior1, Superior2, Superior3, Superior4, Superior5, Superior6, Superior7, CveSubSubSubSubLinea, 1, "")
    ...
    Sub InicializaGrid()
        ...
        Try
            ...
            DGrid.Columns(0).HeaderText = "IdL4"
            ...
            DGrid.Columns(22).HeaderText = "CveL4"
            DGrid.Columns(23).HeaderText = "L4"
    ...
    Private Sub Btn_Consultar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btn_Consultar.Click
        Try
            ...
            myForm.Accion = 4
            myForm.Txt_IdL4.Text = DGrid.Rows(DGrid.CurrentRow.Index).Cells("idl4").Value.ToString.Trim()
    ...
    Private Sub NuevoProveedorToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NuevoProveedorToolStripMenuItem.Click
        Try
            ...
            myForm.Txt_CveL3.Text = DGrid.CurrentRow.Cells("cvel3").Value
            myForm.Txt_DescripL3.Text = DGrid.CurrentRow.Cells("l3").Value
            myForm.Txt_IdL3.Enabled = False
            myForm.Txt_CveL3.Enabled = False
            myForm.Txt_DescripL3.Enabled = False
            myForm.Txt_IdL4.Text = DGrid.CurrentRow.Cells("idl4").Value
            myForm.Txt_CveL4.Text = DGrid.CurrentRow.Cells("clave").Value
            myForm.Txt_DescripL4.Text = DGrid.CurrentRow.Cells("descrip").Value
            myForm.Txt_IdL4.Enabled = False
            myForm.Txt_CveL4.Enabled = False
            myForm.Txt_DescripL4.Enabled = False
            myForm.Accion = 1
            myForm.Show()
        Catch ExceptionErr As Exception
            MessageBox.Show(ExceptionErr.Message.ToString)
    ...
    Private Sub Btn_Filtro_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btn_Filtro.Click
        Try
            ...
            If myForm.Txt_IdSubSubSubLinea.Text.Trim <> "" Then
                Superior1 = CInt(myForm.Txt_IdSubSubSubLinea.Text)
            Else
                Superior1 = 0
            End If
            If myForm.Txt_IdSubSubLinea.Text.Trim <> "" Then
                Superior2 = CInt(myForm.Txt_IdSubSubLinea.Text)
            Else
                Superior2 = 0
            End If
            If myForm.Txt_IdSubLinea.Text.Trim <> "" Then
                Superior3 = CInt(myForm.Txt_IdSubLinea.Text)
            Else
                Superior3 = 0
            End If
            If myForm.Txt_IdLinea.Text.Trim <> "" Then
                Superior4 = CInt(myForm.Txt_IdLinea.Text)
            Else
                Superior4 = 0
            End If
            If myForm.Txt_IdFamilia.Text.Trim <> "" Then
                Superior5 = CInt(myForm.Txt_IdFamilia.Text)
            Else
                Superior5 = 0
            End If
            If myForm.Txt_IdDepto.Text.Trim <> "" Then
                Superior6 = CInt(myForm.Txt_IdDepto.Text)
            Else
                Superior6 = 0
            End If
            If myForm.Txt_IdDivisiones.Text.Trim <> "" Then
                Superior7 = CInt(myForm.Txt_IdDivisiones.Text)
            Else
                Superior7 = 0
            End If
            CveSubSubSubSubLinea = myForm.Txt_CveSubSubSubLinea.Text
