Public Class frmPpalDepartamento
    ...
    Private Sub frmPpalProveedores_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            NuevoProveedorToolStripMenuItem.Text = "Agregar Familia"
            ConsultarProveedorToolStripMenuItem.Text = "Consultar Departamento"
    ...
    Private Sub RellenaGrid()
        ...
        Using objCatalogoDeptos As New BCL.BCLEstructura(GLB_ConStringCipSis)
            ...
            Try
                ...
                objDataSet = objCatalogoDeptos.usp_TraerEstDepto(0, Superior1, CveDepto, 1, "")
    ...
    Sub InicializaGrid()
        ...
        Try
            ...
            DGrid.Columns(3).HeaderText = "Division"
            DGrid.Columns(4).HeaderText = "CveDepto"
    ...
    Private Sub Btn_Filtro_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btn_Filtro.Click
        Try
            ...
            If myForm.Txt_IdDivisiones.Text.Trim <> "" Then
                Superior1 = CInt(myForm.Txt_IdDivisiones.Text)
            Else
                Superior1 = 0
            End If
            CveDepto = myForm.Txt_CveDepto.Text
    ...
    Private Sub NuevoProveedorToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NuevoProveedorToolStripMenuItem.Click
        Try
            ...
            myForm.Txt_Clave.Text = DGrid.CurrentRow.Cells("clave").Value
            myForm.Txt_DescripDepto.Text = DGrid.CurrentRow.Cells("descrip").Value
