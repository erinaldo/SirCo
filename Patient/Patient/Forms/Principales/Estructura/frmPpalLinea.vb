Public Class frmPpalLinea
    ...
    Private Sub frmPpalProveedores_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            Call RellenaGrid()
            Call GenerarToolTip()
            NuevoProveedorToolStripMenuItem.Text = "Agregar SubLinea"
            ConsultarProveedorToolStripMenuItem.Text = "Consultar Linea"
    ...
    Private Sub RellenaGrid()
        ...
        Using objCatalogoDeptos As New BCL.BCLEstructura(GLB_ConStringCipSis)
            ...
            Try
                ...
                objDataSet = objCatalogoDeptos.usp_TraerEstLinea(0, Superior1, Superior2, Superior3, CveLinea, 1, "")
    ...
    Sub InicializaGrid()
        ...
        Try
            ...
            DGrid.Columns(0).HeaderText = "IdLinea"
            ...
            DGrid.Columns(10).HeaderText = "CveLinea"
            DGrid.Columns(11).HeaderText = "Linea"
    ...
    Private Sub Btn_Consultar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btn_Consultar.Click
        Try
            ...
            myForm.Accion = 4
            myForm.Txt_IdLinea.Text = DGrid.Rows(DGrid.CurrentRow.Index).Cells("idlinea").Value.ToString.Trim()
    ...
    Private Sub Btn_Filtro_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btn_Filtro.Click
        Try
            ...
            If myForm.Txt_IdFamilia.Text.Trim <> "" Then
                Superior1 = CInt(myForm.Txt_IdFamilia.Text)
            Else
                Superior1 = 0
            End If
            If myForm.Txt_IdDepto.Text.Trim <> "" Then
                Superior2 = CInt(myForm.Txt_IdDepto.Text)
            Else
                Superior2 = 0
            End If
            If myForm.Txt_IdDivisiones.Text.Trim <> "" Then
                Superior3 = CInt(myForm.Txt_IdDivisiones.Text)
            Else
                Superior3 = 0
            End If
            CveLinea = myForm.Txt_CveLinea.Text
    ...
    Private Sub NuevoProveedorToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NuevoProveedorToolStripMenuItem.Click
        Try
            ...
            myForm.Txt_CveLinea.Text = DGrid.CurrentRow.Cells("clave").Value
            myForm.Txt_DescripLinea.Text = DGrid.CurrentRow.Cells("descrip").Value
