Public Class frmPpalL1
    ...
    Private Sub frmPpalProveedores_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            Call RellenaGrid()
            Call GenerarToolTip()
            NuevoProveedorToolStripMenuItem.Text = "Agregar SubSubLinea"
            ConsultarProveedorToolStripMenuItem.Text = "Consultar SubLinea"
    ...
    Private Sub RellenaGrid()
        ...
        Using objCatalogoDeptos As New BCL.BCLEstructura(GLB_ConStringCipSis)
            ...
            Try
                ...
                objDataSet = objCatalogoDeptos.usp_TraerEstl1(0, Superior1, Superior2, Superior3, Superior4, CveSubLinea, 1, "")
    ...
    Sub InicializaGrid()
        ...
        Try
            ...
            DGrid.Columns(0).HeaderText = "IdL1"
            ...
            DGrid.Columns(13).HeaderText = "CveL1"
            DGrid.Columns(14).HeaderText = "L1"
    ...
    Private Sub Btn_Nuevo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btn_Nuevo.Click
        Try
            Dim myForm As New frmCatalogoL1
            myForm.Accion = 1
            myForm.ShowDialog()
            Call RellenaGrid()
        Catch ExceptionErr As Exception
    ...
    Private Sub Btn_Consultar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btn_Consultar.Click
        Try
            ...
            myForm.Accion = 4
            myForm.Txt_IdL1.Text = DGrid.Rows(DGrid.CurrentRow.Index).Cells("idl1").Value.ToString.Trim()
    ...
    Private Sub Btn_Filtro_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btn_Filtro.Click
        Try
            ...
            If myForm.Txt_IdLinea.Text.Trim <> "" Then
                Superior1 = CInt(myForm.Txt_IdLinea.Text)
            Else
                Superior1 = 0
            End If
            If myForm.Txt_IdFamilia.Text.Trim <> "" Then
                Superior2 = CInt(myForm.Txt_IdFamilia.Text)
            Else
                Superior2 = 0
            End If
            If myForm.Txt_IdDepto.Text.Trim <> "" Then
                Superior3 = CInt(myForm.Txt_IdDepto.Text)
            Else
                Superior3 = 0
            End If
            If myForm.Txt_IdDivisiones.Text.Trim <> "" Then
                Superior4 = CInt(myForm.Txt_IdDivisiones.Text)
            Else
                Superior4 = 0
            End If
            CveSubLinea = myForm.Txt_CveSubLinea.Text
    ...
    Private Sub NuevoProveedorToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NuevoProveedorToolStripMenuItem.Click
        Try
            ...
            myForm.Txt_CveL1.Text = DGrid.CurrentRow.Cells("clave").Value
            myForm.Txt_DescripL1.Text = DGrid.CurrentRow.Cells("descrip").Value
