...
Public Class frmPpalCallCenter

    'mreyes     29/10/2017  11:28 a.m.
    ...
    Private Sub RellenaGrid()
        ...
        Using objTrasp As New BCL.BCLCreditoNuevo(GLB_ConStringCreditoSQL)
            ...
            Try
                ...
                objDataSet = objTrasp.usp_PpalCallCenter()
    ...
    Private Sub Btn_FTP_Click(sender As Object, e As EventArgs)
        My.Computer.Network.UploadFile("c:\yuju\productos.txt", "ftp://home587140532.1and1-data.host/productos.txt", "u81839252-yuju", "ZT_Sirco1981")
    End Sub
    ...
    Private Sub DGrid1_DoubleClick(sender As Object, e As EventArgs) Handles DGrid1.DoubleClick
        Try
            ...
            Myform.Txt_Adeudo.Text = GridView1.GetRowCellValue(Renglon1, "corte1")
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        My.Computer.Network.UploadFile("c:\yuju\productos.txt", "ftp://home587140532.1and1-data.host/productos.txt", "u81839252-yuju", "ZT_Sirco1981", True, 1000)
    End Sub
End Class