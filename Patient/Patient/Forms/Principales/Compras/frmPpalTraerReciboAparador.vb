Public Class frmPpalTraerReciboAparador
    ...
    Private FecReciIniB As String = "1900-01-01"
    Private FecReciFinB As String = "1900-01-01"
    ...
    Private Sub frmPpalProveedores_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        FecReciIniB = Format(Now.Add(New TimeSpan(-7, 0, 0, 0)), "yyyy-MM-dd")
    ...
    Private Sub RellenaGrid()
        ...
        If Cve_Sucursal = "" Or Val(Cve_Sucursal) > 20 Then
            Cve_Sucursal = "01"
        End If
        ...
        Using objRegistro As New BCL.BCLAparador(GLB_ConStringCipSis)
            objDataSet = objRegistro.usp_TraerReciboAparador(Opcion, Sucursal, FecReciIniB, FecReciFinB, Division, Depto, Familia, Linea, L1, L2, L3, L4, L5, L6, Marca, Modelo, idagrupacion, strQueryInv)
        End Using
        ...
        Try
            ...
            If blnNoEsTot = True Then
                ...
                If objDataSet1.Tables(0).Rows.Count > 0 Then
                    ...
                    DGrid.Columns("pares").HeaderText = "No. Modelos"
                    DGrid.Columns("porc").HeaderText = "En Aparador"
    ...
    Sub InicializaGridInventario()
        Try
            ...
            DGrid.Columns("renglon").HeaderText = "Renglon"
            DGrid.Columns("marca").HeaderText = "Marca"
            DGrid.Columns("modelo").HeaderText = "Modelo"
            DGrid.Columns("estilof").HeaderText = "Estilo Fabrica"
            DGrid.Columns("Descripc").HeaderText = "Descripción"
            DGrid.Columns("Medida").HeaderText = "Corrida"
            DGrid.Columns("estructura").Visible = False


            DGrid.Columns("COSTO").HeaderText = "Costo"
            DGrid.Columns("venta").HeaderText = "Venta"
            DGrid.Columns("preciero").HeaderText = "Preciero"
            DGrid.Columns("contado").HeaderText = "Contado"
            DGrid.Columns("credito").HeaderText = "Credito"
            DGrid.Columns("promocion").HeaderText = "Promoción"
            DGrid.Columns("final").HeaderText = "Final"
            DGrid.Columns("Tipo_Preciero").HeaderText = "Tipo Preciero"
            DGrid.Columns("margen1").HeaderText = "Margen 1"
            DGrid.Columns("margen2").HeaderText = "Margen 2"
            DGrid.Columns(3).Visible = False

            DGrid.Columns("COSTO").DefaultCellStyle.Format = "c"
            DGrid.Columns("venta").DefaultCellStyle.Format = "c"
            DGrid.Columns("preciero").DefaultCellStyle.Format = "c"
            DGrid.Columns("contado").DefaultCellStyle.Format = "c"
            DGrid.Columns("credito").DefaultCellStyle.Format = "c"
            DGrid.Columns("promocion").DefaultCellStyle.Format = "c"
            DGrid.Columns("final").DefaultCellStyle.Format = "c"

            DGrid.Columns("COSTO").DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
            DGrid.Columns("venta").DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
            DGrid.Columns("preciero").DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
            DGrid.Columns("contado").DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
            DGrid.Columns("credito").DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
            DGrid.Columns("promocion").DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
            DGrid.Columns("final").DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight

            DGrid.Columns("margen1").DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter
            DGrid.Columns("margen2").DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter

            DGrid.Columns("margen1").DefaultCellStyle.Format = "0#.#0"
            DGrid.Columns("margen2").DefaultCellStyle.Format = "0#.#0"

            DGrid.Columns("COSTO").Visible = False
            DGrid.Columns("venta").Visible = False
            DGrid.Columns("final").Visible = False
            DGrid.Columns("margen1").Visible = False
            DGrid.Columns("margen2").Visible = False
        ...
        Try
            If Opcion = 1 Then
                If IsDBNull(DGrid.CurrentRow.Cells(0).Value) Then
                    ...
                    End If
                Else
                    If DGrid.CurrentRow.Cells(0).Value = Nothing Then
                        If Sucursal = "" Then
                            Sucursal = ""
                        Else
    ...
    Private Sub Btn_Filtro_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btn_Filtro.Click
        Try
            ...
            If FecReciFinB <> "1900-01-01" Then
                myFormFiltros.Chk_UltRecibo.Checked = True
                myFormFiltros.DT_RecIni.Value = FecReciIniB
                myFormFiltros.DT_RecFin.Value = FecReciFinB
            End If
            ...
            If myFormFiltros.Sw_Filtro = True Then
                ...
                If myFormFiltros.Chk_UltRecibo.Checked = True Then
                    ...
                    FecReciIniB = Format(myFormFiltros.DT_RecIni.Value, "yyyy-MM-dd")
                    FecReciFinB = Format(myFormFiltros.DT_RecFin.Value, "yyyy-MM-dd")
                Else
                ...
                IdAgrupacion = myFormFiltros.Txt_Agrupacion.Text
        ...
        Try
            ...
            With DGrid
                For I As Integer = 0 To .Rows.Count - 2
                    ...
                    objDataRow.Item("estilof") = .Rows(I).Cells("estilof").Value
                    objDataRow.Item("descripc") = .Rows(I).Cells("descripc").Value

                    objDataRow.Item("corrida") = .Rows(I).Cells("medida").Value
                    objDataRow.Item("estructura") = .Rows(I).Cells("estructura").Value

                    objDataRow.Item("preciero") = Format(.Rows(I).Cells("preciero").Value, "#0")
                    ...
                    objDataRow.Item("tipo_preciero") = .Rows(I).Cells("tipo_preciero").Value
