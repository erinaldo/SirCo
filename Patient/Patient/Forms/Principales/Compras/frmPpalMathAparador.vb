Public Class frmPpalMathAparador
    'mreyes 22/Mayo/2015    05:26 p.m.
    ...
    Private Sub RellenaGrid()
        ...
        If Accion = 2 Then
            ...
            Using objRegistro As New BCL.BCLAparador(GLB_ConStringCipSis)
                objDataSet = objRegistro.usp_TraerMatchAparador(Opcion, Sucursales(), Division, Depto, Familia, Linea, L1, L2, L3, L4, L5, L6, Marca, Modelo, strQueryInv)
            End Using
    ...
    Sub InicializaGridInventario()
        Try
            ...
            If Opcion = 13 Then
                DGrid.Columns("pares").Visible = False
            End If
    ...
    Private Sub DGrid_CellFormatting(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellFormattingEventArgs) Handles DGrid.CellFormatting
        Try
            If Opcion <> 13 Then Exit Sub

            'If Me.DGrid.Columns(e.ColumnIndex).Name <> "porc" Then Exit Sub
            If e.RowIndex = DGrid.RowCount - 1 Then

                Exit Sub
            End If

            If Val(DGrid.Rows(e.RowIndex).Cells("pares").Value) <> 0 Then Exit Sub

            If (DGrid.Rows(e.RowIndex).Cells("porc").Value) = "NO" Then
                DGrid.Rows(e.RowIndex).Cells("porc").Style.BackColor = Color.Red
            ...
            Else
                DGrid.Rows(e.RowIndex).Cells("porc").Style.BackColor = Color.Yellow
                DGrid.Rows(e.RowIndex).Cells("porc").Style.Font = New Font(DGrid.DefaultCellStyle.Font.FontFamily, DGrid.DefaultCellStyle.Font.Size, FontStyle.Bold)
            End If
