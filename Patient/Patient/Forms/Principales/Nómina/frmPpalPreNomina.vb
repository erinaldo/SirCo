Public Class frmPpalPreNomina
    'mreyes 15/Abril/2015   05:44 p.m.

    Private objDataSet As Data.DataSet
    Dim Sw_NoRegistros As Boolean = False
    Public idEmpleadoB As Integer = 0
    Dim idPercDeducB As Integer = 0
    Public InicioIniB As Date = "1900-01-01"
    Public InicioFinB As Date = "1900-01-01"
    Dim EstatusB As String = ""
    Dim Sw_Pintar As Boolean = False
    Dim Sw_Load As Boolean = True
    Dim TiendaB As String = "S"
        ...
        Try
            ...
            Using objCantArti As New BCL.BCLMySqlGral(GLB_ConStringNomSis)
                ...
                If objDataSet1.Tables(0).Rows.Count > 0 Then
                    ...
                    InicioIniB = Format(objDataSet1.Tables(0).Rows(0).Item("fechaini"), "yyyy-MM-dd")
                    InicioFinB = Format(objDataSet1.Tables(0).Rows(0).Item("fechafin"), "yyyy-MM-dd")
    ...
    Private Sub RellenaGrid()
        ...
        Using objRepetitivo As New BCL.BCLCatalogoRepetitivo(GLB_ConStringNomSis)
            ...
            Try
                ...
                objDataSet = objRepetitivo.usp_PpalCatalogoPreNomina(idEmpleadoB, idPercDeducB, EstatusB, InicioIniB, InicioFinB, TiendaB, GLB_CveSucursal)
    ...
    Sub InicializaGrid()
        'mreyes 21/Abril/2015   11:27 a.m.
        Try
            ...
            DGrid.Columns(7).HeaderText = "Hora"
            ...
            DGrid.Columns(12).HeaderText = "Usuario Registra"
            DGrid.Columns(13).HeaderText = "Usuario Modifica"
    ...
    Private Sub Btn_Nuevo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btn_Nuevo.Click
        ...
        myForm.Sw_Tienda = "S"
        myForm.Text = "Catálogo de Pre-Nómina"
        myForm.Accion = 1
        myForm.ShowDialog()
        Call RellenaGrid()
    End Sub
