Public Class frmPpalCajaCalzado
    'mreyes 02/Marzo/2016   11:00 a.m.
    ...
    Private Sub RellenaGrid()
        ...
        Using objPedidoNuevo As New BCL.BCLAjustes(GLB_ConStringCipSis)
            Try
                ...
                objDataSet = objPedidoNuevo.usp_PpalCajaCalzado(1, sucursalb, idcajacalzadoini, idcajacalzadofin, FechaInib, FechaFinb)
    ...
    Sub InicializaGrid()
        ...
        Try
            ...
            DGrid.Columns(0).HeaderText = "Fecha"
            DGrid.Columns(1).HeaderText = "Det"
            DGrid.Columns(2).HeaderText = "Sucursal"
            DGrid.Columns(3).HeaderText = "Folio"
            DGrid.Columns(4).HeaderText = "Folio Bulto"
            DGrid.Columns(5).HeaderText = "Proveedor"
            DGrid.Columns(6).HeaderText = "Fecha Recibo"
            DGrid.Columns(7).HeaderText = "Serie"
            DGrid.Columns(8).HeaderText = "Marca Anterior"
            DGrid.Columns(9).HeaderText = "Modelo Anterior"
            DGrid.Columns(10).HeaderText = "Corrida Anterior"
            DGrid.Columns(11).HeaderText = "Medida Anterior"
            DGrid.Columns(12).HeaderText = "Marca Nuevo"
            DGrid.Columns(13).HeaderText = "Modelo Nuevo"
            DGrid.Columns(14).HeaderText = "Corrida Nuevo"
            DGrid.Columns(15).HeaderText = "Medida Nuevo"
            DGrid.Columns(16).HeaderText = "Motivo"
            DGrid.Columns(17).HeaderText = "Id Usuario"
            DGrid.Columns(18).HeaderText = "Fum"
    ...
    Private Sub Btn_Filtro_Click_1(sender As Object, e As EventArgs) Handles Btn_Filtro.Click
        'mreyes 28/Febrero/2012 10:08 a.m.

        Dim myForm As New frmFiltrosEstilos
