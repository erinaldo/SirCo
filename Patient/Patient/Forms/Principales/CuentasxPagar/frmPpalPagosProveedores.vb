...
Public Class frmPpalPagosProveedores
    ...
    Sub InicializaGrid()
        ...
        Try
            ...
            GridView1.Columns(6).Caption = "Ene-" & Anio
            GridView1.Columns(7).Caption = "Feb-" & Anio
            GridView1.Columns(8).Caption = "Mar-" & Anio
            GridView1.Columns(9).Caption = "Abr-" & Anio
            GridView1.Columns(10).Caption = "May-" & Anio
            GridView1.Columns(11).Caption = "Jun-" & Anio
            GridView1.Columns(12).Caption = "Jul-" & Anio
            GridView1.Columns(13).Caption = "Ago-" & Anio
            GridView1.Columns(14).Caption = "Sep-" & Anio
            GridView1.Columns(15).Caption = "Oct-" & Anio
            GridView1.Columns(16).Caption = "Nov-" & Anio
            GridView1.Columns(17).Caption = "Dic-" & Anio

            GridView1.Columns(18).Caption = "Ene-" & AnioSig
            GridView1.Columns(19).Caption = "Feb-" & AnioSig
            GridView1.Columns(20).Caption = "Mar-" & AnioSig
            GridView1.Columns(21).Caption = "Abr-" & AnioSig
            GridView1.Columns(22).Caption = "May-" & AnioSig
            GridView1.Columns(23).Caption = "Jun-" & AnioSig
            GridView1.Columns(24).Caption = "Jul-" & AnioSig
            GridView1.Columns(25).Caption = "Ago-" & AnioSig
            GridView1.Columns(26).Caption = "Sep-" & AnioSig
            GridView1.Columns(27).Caption = "Oct-" & AnioSig
            GridView1.Columns(28).Caption = "Nov-" & AnioSig
            GridView1.Columns(29).Caption = "Dic-" & AnioSig
    ...
    Private Sub RellenaGrid()
        ...
        Using objTrasp As New BCL.BCLPasivo(GLB_ConStringSirCoSQL)
            ...
            Try
                ...
                objDataSet = objTrasp.usp_PpalPagosProveedores(DEFechaIni.EditValue, DEFechaFin.EditValue)
    ...
    Private Sub frmPpalPasivoProveedores_Load(sender As Object, e As EventArgs) Handles Me.Load
        Try
            ...
            DEFechaIni.EditValue = Format(DateSerial(Now.Year, Now.Month, 6), "yyyy-MM-dd")
