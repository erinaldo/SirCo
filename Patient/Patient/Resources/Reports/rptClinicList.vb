...
Public Class rptClinicList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Bitacora.rptClinicList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptClinicList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptClinicList = New rptClinicList
        rpt.Site = Me.Site
        Return rpt
    End Function
