...
Public Class rptAusentismo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Bitacora.rptAusentismo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAusentismo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAusentismo = New rptAusentismo
        rpt.Site = Me.Site
        Return rpt
    End Function
