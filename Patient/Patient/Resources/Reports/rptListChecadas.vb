...
Public Class rptListChecadas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Bitacora.rptListChecadas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptListChecadas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptListChecadas = New rptListChecadas
        rpt.Site = Me.Site
        Return rpt
    End Function
