...
Public Class rptPatientList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Bitacora.rptPatientList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPatientList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPatientList = New rptPatientList
        rpt.Site = Me.Site
        Return rpt
    End Function
